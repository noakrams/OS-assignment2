 ...
 */
    ...
    lo = x % 127773;
      16:	66fd                	lui	a3,0x1f
      18:	31d68693          	addi	a3,a3,797 # 1f31d <__global_pointer$+0x1d314>
      1c:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
      20:	6611                	lui	a2,0x4
      22:	1a760613          	addi	a2,a2,423 # 41a7 <__global_pointer$+0x219e>
      26:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
      2a:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
      2e:	76fd                	lui	a3,0xfffff
      30:	4ec68693          	addi	a3,a3,1260 # fffffffffffff4ec <__global_pointer$+0xffffffffffffd4e3>
...
rand(void)
{
    ...
    return (do_rand(&rand_next));
      ...
      64:	7b050513          	addi	a0,a0,1968 # 1810 <rand_next>
...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	46e50513          	addi	a0,a0,1134 # 1508 <csem_free+0x3a>
      a2:	00001097          	auipc	ra,0x1
      a6:	e2c080e7          	jalr	-468(ra) # ece <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	45e50513          	addi	a0,a0,1118 # 1508 <csem_free+0x3a>
      b2:	00001097          	auipc	ra,0x1
      b6:	e24080e7          	jalr	-476(ra) # ed6 <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	45450513          	addi	a0,a0,1108 # 1510 <csem_free+0x42>
  ...
  chdir("/");
      ...
      da:	45a50513          	addi	a0,a0,1114 # 1530 <csem_free+0x62>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	45a98993          	addi	s3,s3,1114 # 1540 <csem_free+0x72>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	44898993          	addi	s3,s3,1096 # 1538 <csem_free+0x6a>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
     ...
     100:	724a0a13          	addi	s4,s4,1828 # 1820 <buf.0>
     104:	a825                	j	13c <go+0xc4>
      close(open("grindir/../a", O_CREATE|O_RDWR));
     106:	20200593          	li	a1,514
     10a:	00001517          	auipc	a0,0x1
     10e:	43e50513          	addi	a0,a0,1086 # 1548 <csem_free+0x7a>
    ...
    if(what == 1){
     ...
     2a2:	52258593          	addi	a1,a1,1314 # 17c0 <csem_free+0x2f2>
     ...
     2c6:	50650513          	addi	a0,a0,1286 # 17c8 <csem_free+0x2fa>
     ...
     2e4:	27850513          	addi	a0,a0,632 # 1558 <csem_free+0x8a>
     ...
     36c:	21050513          	addi	a0,a0,528 # 1578 <csem_free+0xaa>
     ...
     38e:	1fe50513          	addi	a0,a0,510 # 1588 <csem_free+0xba>
     ...
     3c6:	18650513          	addi	a0,a0,390 # 1548 <csem_free+0x7a>
     3ca:	00001097          	auipc	ra,0x1
     3ce:	b04080e7          	jalr	-1276(ra) # ece <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     3d2:	20200593          	li	a1,514
     3d6:	00001517          	auipc	a0,0x1
     3da:	1ca50513          	addi	a0,a0,458 # 15a0 <csem_free+0xd2>
     ...
     430:	1a450513          	addi	a0,a0,420 # 15d0 <csem_free+0x102>
     434:	00001097          	auipc	ra,0x1
     438:	a82080e7          	jalr	-1406(ra) # eb6 <unlink>
     43c:	b1dd                	j	122 <go+0xaa>
      unlink("b");
     43e:	00001517          	auipc	a0,0x1
     442:	15a50513          	addi	a0,a0,346 # 1598 <csem_free+0xca>
     446:	00001097          	auipc	ra,0x1
     44a:	a70080e7          	jalr	-1424(ra) # eb6 <unlink>
      link("../grindir/./../a", "../b");
     44e:	00001597          	auipc	a1,0x1
     452:	12258593          	addi	a1,a1,290 # 1570 <csem_free+0xa2>
     456:	00001517          	auipc	a0,0x1
     45a:	18250513          	addi	a0,a0,386 # 15d8 <csem_free+0x10a>
     45e:	00001097          	auipc	ra,0x1
     462:	a68080e7          	jalr	-1432(ra) # ec6 <link>
     466:	b975                	j	122 <go+0xaa>
      unlink("../grindir/../a");
     468:	00001517          	auipc	a0,0x1
     46c:	18850513          	addi	a0,a0,392 # 15f0 <csem_free+0x122>
     470:	00001097          	auipc	ra,0x1
     474:	a46080e7          	jalr	-1466(ra) # eb6 <unlink>
      link(".././b", "/grindir/../a");
     478:	00001597          	auipc	a1,0x1
     47c:	10058593          	addi	a1,a1,256 # 1578 <csem_free+0xaa>
     480:	00001517          	auipc	a0,0x1
     484:	18050513          	addi	a0,a0,384 # 1600 <csem_free+0x132>
     ...
     4b8:	15450513          	addi	a0,a0,340 # 1608 <csem_free+0x13a>
     ...
     506:	10650513          	addi	a0,a0,262 # 1608 <csem_free+0x13a>
     ...
     518:	952080e7          	jalr	-1710(ra) # e66 <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     51e:	77b50513          	addi	a0,a0,1915 # 177b <csem_free+0x2ad>
     ...
     566:	0be50513          	addi	a0,a0,190 # 1620 <csem_free+0x152>
     ...
     594:	05850513          	addi	a0,a0,88 # 15e8 <csem_free+0x11a>
     ...
     5b6:	05650513          	addi	a0,a0,86 # 1608 <csem_free+0x13a>
     ...
     5d0:	06450513          	addi	a0,a0,100 # 1630 <csem_free+0x162>
     ...
     620:	fec50513          	addi	a0,a0,-20 # 1608 <csem_free+0x13a>
     ...
     67c:	fd050513          	addi	a0,a0,-48 # 1648 <csem_free+0x17a>
     ...
     6a8:	fbc58593          	addi	a1,a1,-68 # 1660 <csem_free+0x192>
     ...
     7aa:	e6250513          	addi	a0,a0,-414 # 1608 <csem_free+0x13a>
     ...
     7c4:	ee850513          	addi	a0,a0,-280 # 16a8 <csem_free+0x1da>
     7c8:	00000097          	auipc	ra,0x0
     7cc:	6ee080e7          	jalr	1774(ra) # eb6 <unlink>
      int fd1 = open("c", O_CREATE|O_RDWR);
     7d0:	20200593          	li	a1,514
     7d4:	00001517          	auipc	a0,0x1
     7d8:	ed450513          	addi	a0,a0,-300 # 16a8 <csem_free+0x1da>
     ...
     7f0:	e7458593          	addi	a1,a1,-396 # 1660 <csem_free+0x192>
     ...
     836:	e7650513          	addi	a0,a0,-394 # 16a8 <csem_free+0x1da>
     83a:	00000097          	auipc	ra,0x0
     83e:	67c080e7          	jalr	1660(ra) # eb6 <unlink>
     842:	b0c5                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     844:	00001517          	auipc	a0,0x1
     848:	e6c50513          	addi	a0,a0,-404 # 16b0 <csem_free+0x1e2>
     ...
     862:	e6a50513          	addi	a0,a0,-406 # 16c8 <csem_free+0x1fa>
     ...
     87c:	e6850513          	addi	a0,a0,-408 # 16e0 <csem_free+0x212>
     ...
     898:	e6450513          	addi	a0,a0,-412 # 16f8 <csem_free+0x22a>
     ...
     8b2:	e7250513          	addi	a0,a0,-398 # 1720 <csem_free+0x252>
     ...
     8cc:	d8058593          	addi	a1,a1,-640 # 1648 <csem_free+0x17a>
     8d0:	4509                	li	a0,2
     ...
     8e8:	d6458593          	addi	a1,a1,-668 # 1648 <csem_free+0x17a>
     8ec:	4509                	li	a0,2
     ...
     944:	e0858593          	addi	a1,a1,-504 # 1748 <csem_free+0x27a>
     948:	4509                	li	a0,2
     ...
     9b8:	c5458593          	addi	a1,a1,-940 # 1608 <csem_free+0x13a>
     9bc:	4509                	li	a0,2
     ...
     a04:	d4858593          	addi	a1,a1,-696 # 1748 <csem_free+0x27a>
     a08:	4509                	li	a0,2
     ...
     a48:	d0458593          	addi	a1,a1,-764 # 1748 <csem_free+0x27a>
     a4c:	4509                	li	a0,2
     ...
     ab0:	b5c58593          	addi	a1,a1,-1188 # 1608 <csem_free+0x13a>
     ab4:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     ad8:	b1450513          	addi	a0,a0,-1260 # 15e8 <csem_free+0x11a>
     adc:	00000097          	auipc	ra,0x0
     ae0:	3da080e7          	jalr	986(ra) # eb6 <unlink>
  unlink("b");
     ae4:	00001517          	auipc	a0,0x1
     ae8:	ab450513          	addi	a0,a0,-1356 # 1598 <csem_free+0xca>
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     b0a:	d0f73523          	sd	a5,-758(a4) # 1810 <rand_next>
    go(0);
     b0e:	4501                	li	a0,0
    ...
    printf("grind: fork failed\n");
     ...
     b1c:	af050513          	addi	a0,a0,-1296 # 1608 <csem_free+0x13a>
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     b42:	6789                	lui	a5,0x2
     b44:	c0978793          	addi	a5,a5,-1015 # 1c09 <base+0x1>
     b48:	00001717          	auipc	a4,0x1
     b4c:	ccf73423          	sd	a5,-824(a4) # 1810 <rand_next>
    go(1);
     b50:	4505                	li	a0,1
    ...
    printf("grind: fork failed\n");
     ...
     b5e:	aae50513          	addi	a0,a0,-1362 # 1608 <csem_free+0x13a>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     fa8:	85450513          	addi	a0,a0,-1964 # 17f8 <digits>
     fac:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1074:	788b8b93          	addi	s7,s7,1928 # 17f8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    11b4:	64090913          	addi	s2,s2,1600 # 17f0 <csem_free+0x322>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    127c:	5a07b783          	ld	a5,1440(a5) # 1818 <freep>
    ...
    12aa:	00e6ea63          	bltu	a3,a4,12be <free+0x50>
{
  ...
  freep = p;
    ...
    12ec:	52f73823          	sd	a5,1328(a4) # 1818 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    131e:	4fe53503          	ld	a0,1278(a0) # 1818 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1346:	4d690913          	addi	s2,s2,1238 # 1818 <freep>
  if(p == (char*)-1)
    134a:	5afd                	li	s5,-1
    134c:	a895                	j	13c0 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    134e:	00001797          	auipc	a5,0x1
    1352:	8ba78793          	addi	a5,a5,-1862 # 1c08 <base>
    1356:	00000717          	auipc	a4,0x0
    135a:	4cf73123          	sd	a5,1218(a4) # 1818 <freep>
    ...
    1382:	48a73d23          	sd	a0,1178(a4) # 1818 <freep>
      return (void*)(p + 1);
...
void csem_down(struct counting_semaphore *sem) {
    ...
    13e6:	84aa                	mv	s1,a0
    bsem_down(sem->bsem2);
    13e8:	4148                	lw	a0,4(a0)
    13ea:	00000097          	auipc	ra,0x0
    13ee:	b34080e7          	jalr	-1228(ra) # f1e <bsem_down>
    bsem_down(sem->bsem1);
    13f2:	4088                	lw	a0,0(s1)
    13f4:	00000097          	auipc	ra,0x0
    13f8:	b2a080e7          	jalr	-1238(ra) # f1e <bsem_down>
    sem->count -= 1;
    13fc:	449c                	lw	a5,8(s1)
    13fe:	37fd                	addiw	a5,a5,-1
    1400:	0007871b          	sext.w	a4,a5
    1404:	c49c                	sw	a5,8(s1)
    if (sem->count > 0)
    1406:	00e04c63          	bgtz	a4,141e <csem_down+0x42>
    	bsem_up(sem->bsem2);
    bsem_up(sem->bsem1);
    140a:	4088                	lw	a0,0(s1)
    140c:	00000097          	auipc	ra,0x0
    1410:	b1a080e7          	jalr	-1254(ra) # f26 <bsem_up>
}
    1414:	60e2                	ld	ra,24(sp)
    1416:	6442                	ld	s0,16(sp)
    1418:	64a2                	ld	s1,8(sp)
    141a:	6105                	addi	sp,sp,32
    141c:	8082                	ret
    	bsem_up(sem->bsem2);
    141e:	40c8                	lw	a0,4(s1)
    1420:	00000097          	auipc	ra,0x0
    1424:	b06080e7          	jalr	-1274(ra) # f26 <bsem_up>
    1428:	b7cd                	j	140a <csem_down+0x2e>

000000000000142a <csem_up>:
...
void csem_up(struct counting_semaphore *sem) {
    ...
    1430:	e426                	sd	s1,8(sp)
    1432:	1000                	addi	s0,sp,32
    1434:	84aa                	mv	s1,a0
	bsem_down(sem->bsem1);
    1436:	4108                	lw	a0,0(a0)
    1438:	00000097          	auipc	ra,0x0
    143c:	ae6080e7          	jalr	-1306(ra) # f1e <bsem_down>
	sem->count += 1;
    1440:	449c                	lw	a5,8(s1)
    1442:	2785                	addiw	a5,a5,1
    1444:	0007871b          	sext.w	a4,a5
    1448:	c49c                	sw	a5,8(s1)
	if (sem->count == 1)
    144a:	4785                	li	a5,1
    144c:	00f70c63          	beq	a4,a5,1464 <csem_up+0x3a>
		bsem_up(sem->bsem2);
	bsem_up(sem->bsem1);
    1450:	4088                	lw	a0,0(s1)
    1452:	00000097          	auipc	ra,0x0
    1456:	ad4080e7          	jalr	-1324(ra) # f26 <bsem_up>
}
    145a:	60e2                	ld	ra,24(sp)
    145c:	6442                	ld	s0,16(sp)
    145e:	64a2                	ld	s1,8(sp)
    1460:	6105                	addi	sp,sp,32
    1462:	8082                	ret
		bsem_up(sem->bsem2);
    1464:	40c8                	lw	a0,4(s1)
    1466:	00000097          	auipc	ra,0x0
    146a:	ac0080e7          	jalr	-1344(ra) # f26 <bsem_up>
    146e:	b7cd                	j	1450 <csem_up+0x26>

0000000000001470 <csem_alloc>:
...
int csem_alloc(struct counting_semaphore *sem, int count) {
    ...
    1486:	ab4080e7          	jalr	-1356(ra) # f36 <bsem_alloc>
    148a:	84aa                	mv	s1,a0
    int bsem2 = bsem_alloc();
    148c:	00000097          	auipc	ra,0x0
    1490:	aaa080e7          	jalr	-1366(ra) # f36 <bsem_alloc>
    if (bsem1 == -1 || bsem2 == -1)
    1494:	57fd                	li	a5,-1
    1496:	00f48d63          	beq	s1,a5,14b0 <csem_alloc+0x40>
    149a:	02f50863          	beq	a0,a5,14ca <csem_alloc+0x5a>
        return -1; 
    sem->bsem1 = bsem1;
    149e:	00992023          	sw	s1,0(s2)
    sem->bsem2 = bsem2;
    14a2:	00a92223          	sw	a0,4(s2)
    if (count == 0)
    14a6:	00098d63          	beqz	s3,14c0 <csem_alloc+0x50>
        // Binary semaphore first value = min(1, count)
        bsem_down(sem->bsem2); 
    sem->count = count;
    14aa:	01392423          	sw	s3,8(s2)
    return 0;
    14ae:	4481                	li	s1,0
}
    14b0:	8526                	mv	a0,s1
    14b2:	70a2                	ld	ra,40(sp)
    14b4:	7402                	ld	s0,32(sp)
    14b6:	64e2                	ld	s1,24(sp)
    14b8:	6942                	ld	s2,16(sp)
    14ba:	69a2                	ld	s3,8(sp)
    14bc:	6145                	addi	sp,sp,48
    14be:	8082                	ret
        bsem_down(sem->bsem2); 
    14c0:	00000097          	auipc	ra,0x0
    14c4:	a5e080e7          	jalr	-1442(ra) # f1e <bsem_down>
    14c8:	b7cd                	j	14aa <csem_alloc+0x3a>
        return -1; 
    14ca:	84aa                	mv	s1,a0
    14cc:	b7d5                	j	14b0 <csem_alloc+0x40>

00000000000014ce <csem_free>:
...
void csem_free(struct counting_semaphore *sem) {
    ...
    14d4:	e426                	sd	s1,8(sp)
    14d6:	1000                	addi	s0,sp,32
    14d8:	84aa                	mv	s1,a0
    bsem_free(sem->bsem1);
    14da:	4108                	lw	a0,0(a0)
    14dc:	00000097          	auipc	ra,0x0
    14e0:	a52080e7          	jalr	-1454(ra) # f2e <bsem_free>
    bsem_free(sem->bsem2);
    14e4:	40c8                	lw	a0,4(s1)
    14e6:	00000097          	auipc	ra,0x0
    14ea:	a48080e7          	jalr	-1464(ra) # f2e <bsem_free>
    free(sem);
    14ee:	8526                	mv	a0,s1
    14f0:	00000097          	auipc	ra,0x0
    14f4:	d7e080e7          	jalr	-642(ra) # 126e <free>
}
    14f8:	60e2                	ld	ra,24(sp)
    14fa:	6442                	ld	s0,16(sp)
