...
main(int argc, char **argv)
{
  ...
  4e:	92658593          	addi	a1,a1,-1754 # 970 <csem_free+0x34>
  52:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e2:	4b2b8b93          	addi	s7,s7,1202 # 990 <digits>
 ...
 622:	36a90913          	addi	s2,s2,874 # 988 <csem_free+0x4c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ea:	2c27b783          	ld	a5,706(a5) # 9a8 <freep>
 ...
 718:	00e6ea63          	bltu	a3,a4,72c <free+0x50>
{
 ...
 75a:	24f73923          	sd	a5,594(a4) # 9a8 <freep>
}
 75e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 78c:	22053503          	ld	a0,544(a0) # 9a8 <freep>
 ...
 7b4:	1f890913          	addi	s2,s2,504 # 9a8 <freep>
  if(p == (char*)-1)
 7b8:	5afd                	li	s5,-1
 7ba:	a895                	j	82e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7bc:	00000797          	auipc	a5,0x0
 7c0:	1f478793          	addi	a5,a5,500 # 9b0 <base>
 ...
 7f0:	1aa73e23          	sd	a0,444(a4) # 9a8 <freep>
      return (void*)(p + 1);
...
void csem_down(struct counting_semaphore *sem) {
 ...
 85c:	b34080e7          	jalr	-1228(ra) # 38c <bsem_down>
    bsem_down(sem->bsem1);
 860:	4088                	lw	a0,0(s1)
 862:	00000097          	auipc	ra,0x0
 866:	b2a080e7          	jalr	-1238(ra) # 38c <bsem_down>
    sem->count -= 1;
 86a:	449c                	lw	a5,8(s1)
 86c:	37fd                	addiw	a5,a5,-1
 86e:	0007871b          	sext.w	a4,a5
 872:	c49c                	sw	a5,8(s1)
    if (sem->count > 0)
 874:	00e04c63          	bgtz	a4,88c <csem_down+0x42>
    	bsem_up(sem->bsem2);
    bsem_up(sem->bsem1);
 878:	4088                	lw	a0,0(s1)
 87a:	00000097          	auipc	ra,0x0
 87e:	b1a080e7          	jalr	-1254(ra) # 394 <bsem_up>
}
 ...
 892:	b06080e7          	jalr	-1274(ra) # 394 <bsem_up>
 896:	b7cd                	j	878 <csem_down+0x2e>

0000000000000898 <csem_up>:
...
void csem_up(struct counting_semaphore *sem) {
 ...
 8aa:	ae6080e7          	jalr	-1306(ra) # 38c <bsem_down>
	sem->count += 1;
 8ae:	449c                	lw	a5,8(s1)
 ...
 8b6:	c49c                	sw	a5,8(s1)
	if (sem->count == 1)
 8b8:	4785                	li	a5,1
 8ba:	00f70c63          	beq	a4,a5,8d2 <csem_up+0x3a>
		bsem_up(sem->bsem2);
	bsem_up(sem->bsem1);
 8be:	4088                	lw	a0,0(s1)
 8c0:	00000097          	auipc	ra,0x0
 8c4:	ad4080e7          	jalr	-1324(ra) # 394 <bsem_up>
}
 ...
 8d8:	ac0080e7          	jalr	-1344(ra) # 394 <bsem_up>
 8dc:	b7cd                	j	8be <csem_up+0x26>

00000000000008de <csem_alloc>:
...
int csem_alloc(struct counting_semaphore *sem, int count) {
 ...
 8f4:	ab4080e7          	jalr	-1356(ra) # 3a4 <bsem_alloc>
 8f8:	84aa                	mv	s1,a0
    int bsem2 = bsem_alloc();
 8fa:	00000097          	auipc	ra,0x0
 8fe:	aaa080e7          	jalr	-1366(ra) # 3a4 <bsem_alloc>
    if (bsem1 == -1 || bsem2 == -1)
 902:	57fd                	li	a5,-1
 904:	00f48d63          	beq	s1,a5,91e <csem_alloc+0x40>
 908:	02f50863          	beq	a0,a5,938 <csem_alloc+0x5a>
        return -1; 
    sem->bsem1 = bsem1;
 90c:	00992023          	sw	s1,0(s2)
    sem->bsem2 = bsem2;
 910:	00a92223          	sw	a0,4(s2)
    if (count == 0)
 914:	00098d63          	beqz	s3,92e <csem_alloc+0x50>
        // Binary semaphore first value = min(1, count)
        bsem_down(sem->bsem2); 
    sem->count = count;
 918:	01392423          	sw	s3,8(s2)
    return 0;
 91c:	4481                	li	s1,0
}
 91e:	8526                	mv	a0,s1
 ...
 932:	a5e080e7          	jalr	-1442(ra) # 38c <bsem_down>
 936:	b7cd                	j	918 <csem_alloc+0x3a>
        return -1; 
 938:	84aa                	mv	s1,a0
 93a:	b7d5                	j	91e <csem_alloc+0x40>

000000000000093c <csem_free>:
...
void csem_free(struct counting_semaphore *sem) {
 ...
 94e:	a52080e7          	jalr	-1454(ra) # 39c <bsem_free>
    bsem_free(sem->bsem2);
 952:	40c8                	lw	a0,4(s1)
 954:	00000097          	auipc	ra,0x0
 958:	a48080e7          	jalr	-1464(ra) # 39c <bsem_free>
    free(sem);
 95c:	8526                	mv	a0,s1
 95e:	00000097          	auipc	ra,0x0
 962:	d7e080e7          	jalr	-642(ra) # 6dc <free>
}
