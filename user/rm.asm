...
main(int argc, char *argv[])
{
  ...
  42:	94a58593          	addi	a1,a1,-1718 # 988 <csem_free+0x3a>
  46:	4509                	li	a0,2
  ...
  60:	94458593          	addi	a1,a1,-1724 # 9a0 <csem_free+0x52>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 428:	5a450513          	addi	a0,a0,1444 # 9c8 <digits>
 42c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f4:	4d8b8b93          	addi	s7,s7,1240 # 9c8 <digits>
 ...
 634:	39090913          	addi	s2,s2,912 # 9c0 <csem_free+0x72>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6fc:	2e87b783          	ld	a5,744(a5) # 9e0 <freep>
 ...
 72a:	00e6ea63          	bltu	a3,a4,73e <free+0x50>
{
 ...
 76c:	26f73c23          	sd	a5,632(a4) # 9e0 <freep>
}
 770:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 79e:	24653503          	ld	a0,582(a0) # 9e0 <freep>
 ...
 7c6:	21e90913          	addi	s2,s2,542 # 9e0 <freep>
  if(p == (char*)-1)
 7ca:	5afd                	li	s5,-1
 7cc:	a895                	j	840 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7ce:	00000797          	auipc	a5,0x0
 7d2:	21a78793          	addi	a5,a5,538 # 9e8 <base>
 7d6:	00000717          	auipc	a4,0x0
 7da:	20f73523          	sd	a5,522(a4) # 9e0 <freep>
 7de:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 802:	1ea73123          	sd	a0,482(a4) # 9e0 <freep>
      return (void*)(p + 1);
...
void csem_down(struct counting_semaphore *sem) {
 ...
 86e:	b34080e7          	jalr	-1228(ra) # 39e <bsem_down>
    bsem_down(sem->bsem1);
 872:	4088                	lw	a0,0(s1)
 874:	00000097          	auipc	ra,0x0
 878:	b2a080e7          	jalr	-1238(ra) # 39e <bsem_down>
    sem->count -= 1;
 87c:	449c                	lw	a5,8(s1)
 87e:	37fd                	addiw	a5,a5,-1
 880:	0007871b          	sext.w	a4,a5
 884:	c49c                	sw	a5,8(s1)
    if (sem->count > 0)
 886:	00e04c63          	bgtz	a4,89e <csem_down+0x42>
    	bsem_up(sem->bsem2);
    bsem_up(sem->bsem1);
 88a:	4088                	lw	a0,0(s1)
 88c:	00000097          	auipc	ra,0x0
 890:	b1a080e7          	jalr	-1254(ra) # 3a6 <bsem_up>
}
 894:	60e2                	ld	ra,24(sp)
 896:	6442                	ld	s0,16(sp)
 898:	64a2                	ld	s1,8(sp)
 89a:	6105                	addi	sp,sp,32
 89c:	8082                	ret
    	bsem_up(sem->bsem2);
 89e:	40c8                	lw	a0,4(s1)
 8a0:	00000097          	auipc	ra,0x0
 8a4:	b06080e7          	jalr	-1274(ra) # 3a6 <bsem_up>
 8a8:	b7cd                	j	88a <csem_down+0x2e>

00000000000008aa <csem_up>:
...
void csem_up(struct counting_semaphore *sem) {
 ...
 8bc:	ae6080e7          	jalr	-1306(ra) # 39e <bsem_down>
	sem->count += 1;
 8c0:	449c                	lw	a5,8(s1)
 ...
 8c8:	c49c                	sw	a5,8(s1)
	if (sem->count == 1)
 8ca:	4785                	li	a5,1
 8cc:	00f70c63          	beq	a4,a5,8e4 <csem_up+0x3a>
		bsem_up(sem->bsem2);
	bsem_up(sem->bsem1);
 8d0:	4088                	lw	a0,0(s1)
 8d2:	00000097          	auipc	ra,0x0
 8d6:	ad4080e7          	jalr	-1324(ra) # 3a6 <bsem_up>
}
 ...
 8ea:	ac0080e7          	jalr	-1344(ra) # 3a6 <bsem_up>
 8ee:	b7cd                	j	8d0 <csem_up+0x26>
...
int csem_alloc(struct counting_semaphore *sem, int count) {
 ...
 906:	ab4080e7          	jalr	-1356(ra) # 3b6 <bsem_alloc>
 90a:	84aa                	mv	s1,a0
    int bsem2 = bsem_alloc();
 90c:	00000097          	auipc	ra,0x0
 910:	aaa080e7          	jalr	-1366(ra) # 3b6 <bsem_alloc>
    if (bsem1 == -1 || bsem2 == -1)
 914:	57fd                	li	a5,-1
 916:	00f48d63          	beq	s1,a5,930 <csem_alloc+0x40>
 91a:	02f50863          	beq	a0,a5,94a <csem_alloc+0x5a>
        return -1; 
    sem->bsem1 = bsem1;
 ...
 922:	00a92223          	sw	a0,4(s2)
    if (count == 0)
 926:	00098d63          	beqz	s3,940 <csem_alloc+0x50>
        // Binary semaphore first value = min(1, count)
        bsem_down(sem->bsem2); 
    sem->count = count;
 92a:	01392423          	sw	s3,8(s2)
    return 0;
 92e:	4481                	li	s1,0
}
 930:	8526                	mv	a0,s1
 ...
 944:	a5e080e7          	jalr	-1442(ra) # 39e <bsem_down>
 948:	b7cd                	j	92a <csem_alloc+0x3a>
        return -1; 
 94a:	84aa                	mv	s1,a0
 94c:	b7d5                	j	930 <csem_alloc+0x40>

000000000000094e <csem_free>:
...
void csem_free(struct counting_semaphore *sem) {
 ...
 960:	a52080e7          	jalr	-1454(ra) # 3ae <bsem_free>
    bsem_free(sem->bsem2);
 964:	40c8                	lw	a0,4(s1)
 966:	00000097          	auipc	ra,0x0
 96a:	a48080e7          	jalr	-1464(ra) # 3ae <bsem_free>
    free(sem);
 96e:	8526                	mv	a0,s1
 970:	00000097          	auipc	ra,0x0
 974:	d7e080e7          	jalr	-642(ra) # 6ee <free>
}
