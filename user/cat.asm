...
cat(int fd)
{
  ...
  14:	a8890913          	addi	s2,s2,-1400 # a98 <buf>
  ...
  44:	9e858593          	addi	a1,a1,-1560 # a28 <csem_free+0x34>
  48:	4509                	li	a0,2
  ...
  72:	9d258593          	addi	a1,a1,-1582 # a40 <csem_free+0x4c>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	95658593          	addi	a1,a1,-1706 # a58 <csem_free+0x64>
 10a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ce:	5ae50513          	addi	a0,a0,1454 # a78 <digits>
 4d2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 59a:	4e2b8b93          	addi	s7,s7,1250 # a78 <digits>
 ...
 6da:	39a90913          	addi	s2,s2,922 # a70 <csem_free+0x7c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7a2:	2f27b783          	ld	a5,754(a5) # a90 <freep>
...
malloc(uint nbytes)
{
 ...
 844:	25053503          	ld	a0,592(a0) # a90 <freep>
 ...
 878:	42478793          	addi	a5,a5,1060 # c98 <base>
 87c:	00000717          	auipc	a4,0x0
 880:	20f73a23          	sd	a5,532(a4) # a90 <freep>
 884:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8a8:	1ea73623          	sd	a0,492(a4) # a90 <freep>
      return (void*)(p + 1);
...
void csem_down(struct counting_semaphore *sem) {
 ...
 914:	b34080e7          	jalr	-1228(ra) # 444 <bsem_down>
    bsem_down(sem->bsem1);
 918:	4088                	lw	a0,0(s1)
 91a:	00000097          	auipc	ra,0x0
 91e:	b2a080e7          	jalr	-1238(ra) # 444 <bsem_down>
    sem->count -= 1;
 922:	449c                	lw	a5,8(s1)
 924:	37fd                	addiw	a5,a5,-1
 926:	0007871b          	sext.w	a4,a5
 92a:	c49c                	sw	a5,8(s1)
    if (sem->count > 0)
 92c:	00e04c63          	bgtz	a4,944 <csem_down+0x42>
    	bsem_up(sem->bsem2);
    bsem_up(sem->bsem1);
 930:	4088                	lw	a0,0(s1)
 932:	00000097          	auipc	ra,0x0
 936:	b1a080e7          	jalr	-1254(ra) # 44c <bsem_up>
}
 ...
 94a:	b06080e7          	jalr	-1274(ra) # 44c <bsem_up>
 94e:	b7cd                	j	930 <csem_down+0x2e>

0000000000000950 <csem_up>:
...
void csem_up(struct counting_semaphore *sem) {
 ...
 962:	ae6080e7          	jalr	-1306(ra) # 444 <bsem_down>
	sem->count += 1;
 966:	449c                	lw	a5,8(s1)
 968:	2785                	addiw	a5,a5,1
 96a:	0007871b          	sext.w	a4,a5
 96e:	c49c                	sw	a5,8(s1)
	if (sem->count == 1)
 970:	4785                	li	a5,1
 972:	00f70c63          	beq	a4,a5,98a <csem_up+0x3a>
		bsem_up(sem->bsem2);
	bsem_up(sem->bsem1);
 976:	4088                	lw	a0,0(s1)
 978:	00000097          	auipc	ra,0x0
 97c:	ad4080e7          	jalr	-1324(ra) # 44c <bsem_up>
}
 ...
 990:	ac0080e7          	jalr	-1344(ra) # 44c <bsem_up>
 994:	b7cd                	j	976 <csem_up+0x26>

0000000000000996 <csem_alloc>:
...
int csem_alloc(struct counting_semaphore *sem, int count) {
 ...
 9ac:	ab4080e7          	jalr	-1356(ra) # 45c <bsem_alloc>
 9b0:	84aa                	mv	s1,a0
    int bsem2 = bsem_alloc();
 9b2:	00000097          	auipc	ra,0x0
 9b6:	aaa080e7          	jalr	-1366(ra) # 45c <bsem_alloc>
    if (bsem1 == -1 || bsem2 == -1)
 9ba:	57fd                	li	a5,-1
 9bc:	00f48d63          	beq	s1,a5,9d6 <csem_alloc+0x40>
 9c0:	02f50863          	beq	a0,a5,9f0 <csem_alloc+0x5a>
        return -1; 
    sem->bsem1 = bsem1;
 9c4:	00992023          	sw	s1,0(s2)
    sem->bsem2 = bsem2;
 9c8:	00a92223          	sw	a0,4(s2)
    if (count == 0)
 9cc:	00098d63          	beqz	s3,9e6 <csem_alloc+0x50>
        // Binary semaphore first value = min(1, count)
        bsem_down(sem->bsem2); 
    sem->count = count;
 9d0:	01392423          	sw	s3,8(s2)
    return 0;
 9d4:	4481                	li	s1,0
}
 9d6:	8526                	mv	a0,s1
 ...
 9e0:	69a2                	ld	s3,8(sp)
 9e2:	6145                	addi	sp,sp,48
 9e4:	8082                	ret
        bsem_down(sem->bsem2); 
 9e6:	00000097          	auipc	ra,0x0
 9ea:	a5e080e7          	jalr	-1442(ra) # 444 <bsem_down>
 9ee:	b7cd                	j	9d0 <csem_alloc+0x3a>
        return -1; 
 9f0:	84aa                	mv	s1,a0
 9f2:	b7d5                	j	9d6 <csem_alloc+0x40>

00000000000009f4 <csem_free>:
...
void csem_free(struct counting_semaphore *sem) {
 ...
 a06:	a52080e7          	jalr	-1454(ra) # 454 <bsem_free>
    bsem_free(sem->bsem2);
 a0a:	40c8                	lw	a0,4(s1)
 a0c:	00000097          	auipc	ra,0x0
 a10:	a48080e7          	jalr	-1464(ra) # 454 <bsem_free>
    free(sem);
 a14:	8526                	mv	a0,s1
 a16:	00000097          	auipc	ra,0x0
 a1a:	d7e080e7          	jalr	-642(ra) # 794 <free>
}
 a1e:	60e2                	ld	ra,24(sp)
 a20:	6442                	ld	s0,16(sp)
 a22:	64a2                	ld	s1,8(sp)
 a24:	6105                	addi	sp,sp,32
 a26:	8082                	ret
