...
main(int argc, char *argv[])
{
  ...
  1a:	a3278793          	addi	a5,a5,-1486 # a48 <csem_free+0x66>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	9ec50513          	addi	a0,a0,-1556 # a18 <csem_free+0x36>
  ...
  6c:	9c850513          	addi	a0,a0,-1592 # a30 <csem_free+0x4e>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	98a50513          	addi	a0,a0,-1654 # a40 <csem_free+0x5e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4bc:	5a850513          	addi	a0,a0,1448 # a60 <digits>
 4c0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 588:	4dcb8b93          	addi	s7,s7,1244 # a60 <digits>
 ...
 6c8:	39490913          	addi	s2,s2,916 # a58 <csem_free+0x76>
        while(*s != 0){
...
free(void *ap)
{
 ...
 790:	2ec7b783          	ld	a5,748(a5) # a78 <freep>
 ...
 7be:	00e6ea63          	bltu	a3,a4,7d2 <free+0x50>
{
 ...
 800:	26f73e23          	sd	a5,636(a4) # a78 <freep>
}
 804:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 832:	24a53503          	ld	a0,586(a0) # a78 <freep>
 ...
 85a:	22290913          	addi	s2,s2,546 # a78 <freep>
  if(p == (char*)-1)
 85e:	5afd                	li	s5,-1
 860:	a895                	j	8d4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 862:	00000797          	auipc	a5,0x0
 866:	21e78793          	addi	a5,a5,542 # a80 <base>
 86a:	00000717          	auipc	a4,0x0
 86e:	20f73723          	sd	a5,526(a4) # a78 <freep>
 872:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 896:	1ea73323          	sd	a0,486(a4) # a78 <freep>
      return (void*)(p + 1);
...
void csem_down(struct counting_semaphore *sem) {
 ...
 902:	b34080e7          	jalr	-1228(ra) # 432 <bsem_down>
    bsem_down(sem->bsem1);
 906:	4088                	lw	a0,0(s1)
 908:	00000097          	auipc	ra,0x0
 90c:	b2a080e7          	jalr	-1238(ra) # 432 <bsem_down>
    sem->count -= 1;
 910:	449c                	lw	a5,8(s1)
 912:	37fd                	addiw	a5,a5,-1
 914:	0007871b          	sext.w	a4,a5
 918:	c49c                	sw	a5,8(s1)
    if (sem->count > 0)
 91a:	00e04c63          	bgtz	a4,932 <csem_down+0x42>
    	bsem_up(sem->bsem2);
    bsem_up(sem->bsem1);
 91e:	4088                	lw	a0,0(s1)
 920:	00000097          	auipc	ra,0x0
 924:	b1a080e7          	jalr	-1254(ra) # 43a <bsem_up>
}
 ...
 938:	b06080e7          	jalr	-1274(ra) # 43a <bsem_up>
 93c:	b7cd                	j	91e <csem_down+0x2e>

000000000000093e <csem_up>:
...
void csem_up(struct counting_semaphore *sem) {
 ...
 950:	ae6080e7          	jalr	-1306(ra) # 432 <bsem_down>
	sem->count += 1;
 954:	449c                	lw	a5,8(s1)
 ...
 95c:	c49c                	sw	a5,8(s1)
	if (sem->count == 1)
 95e:	4785                	li	a5,1
 960:	00f70c63          	beq	a4,a5,978 <csem_up+0x3a>
		bsem_up(sem->bsem2);
	bsem_up(sem->bsem1);
 964:	4088                	lw	a0,0(s1)
 966:	00000097          	auipc	ra,0x0
 96a:	ad4080e7          	jalr	-1324(ra) # 43a <bsem_up>
}
 96e:	60e2                	ld	ra,24(sp)
 970:	6442                	ld	s0,16(sp)
 972:	64a2                	ld	s1,8(sp)
 974:	6105                	addi	sp,sp,32
 976:	8082                	ret
		bsem_up(sem->bsem2);
 978:	40c8                	lw	a0,4(s1)
 97a:	00000097          	auipc	ra,0x0
 97e:	ac0080e7          	jalr	-1344(ra) # 43a <bsem_up>
 982:	b7cd                	j	964 <csem_up+0x26>

0000000000000984 <csem_alloc>:
...
int csem_alloc(struct counting_semaphore *sem, int count) {
 ...
 98e:	e44e                	sd	s3,8(sp)
 990:	1800                	addi	s0,sp,48
 992:	892a                	mv	s2,a0
 994:	89ae                	mv	s3,a1
    int bsem1 = bsem_alloc();
 996:	00000097          	auipc	ra,0x0
 99a:	ab4080e7          	jalr	-1356(ra) # 44a <bsem_alloc>
 99e:	84aa                	mv	s1,a0
    int bsem2 = bsem_alloc();
 9a0:	00000097          	auipc	ra,0x0
 9a4:	aaa080e7          	jalr	-1366(ra) # 44a <bsem_alloc>
    if (bsem1 == -1 || bsem2 == -1)
 9a8:	57fd                	li	a5,-1
 9aa:	00f48d63          	beq	s1,a5,9c4 <csem_alloc+0x40>
 9ae:	02f50863          	beq	a0,a5,9de <csem_alloc+0x5a>
        return -1; 
    sem->bsem1 = bsem1;
 9b2:	00992023          	sw	s1,0(s2)
    sem->bsem2 = bsem2;
 9b6:	00a92223          	sw	a0,4(s2)
    if (count == 0)
 9ba:	00098d63          	beqz	s3,9d4 <csem_alloc+0x50>
        // Binary semaphore first value = min(1, count)
        bsem_down(sem->bsem2); 
    sem->count = count;
 9be:	01392423          	sw	s3,8(s2)
    return 0;
 9c2:	4481                	li	s1,0
}
 9c4:	8526                	mv	a0,s1
 ...
 9d8:	a5e080e7          	jalr	-1442(ra) # 432 <bsem_down>
 9dc:	b7cd                	j	9be <csem_alloc+0x3a>
        return -1; 
 9de:	84aa                	mv	s1,a0
 9e0:	b7d5                	j	9c4 <csem_alloc+0x40>

00000000000009e2 <csem_free>:
...
void csem_free(struct counting_semaphore *sem) {
 ...
 9f4:	a52080e7          	jalr	-1454(ra) # 442 <bsem_free>
    bsem_free(sem->bsem2);
 9f8:	40c8                	lw	a0,4(s1)
 9fa:	00000097          	auipc	ra,0x0
 9fe:	a48080e7          	jalr	-1464(ra) # 442 <bsem_free>
    free(sem);
 a02:	8526                	mv	a0,s1
 a04:	00000097          	auipc	ra,0x0
 a08:	d7e080e7          	jalr	-642(ra) # 782 <free>
}
