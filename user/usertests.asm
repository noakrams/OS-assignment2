...
void test_handler(int signum){
    ...
    wait_sig = 1;
       ...
       e:	7af72723          	sw	a5,1966(a4) # 87b8 <wait_sig>
    printf("Received sigtest\n");
      12:	00006517          	auipc	a0,0x6
      16:	2be50513          	addi	a0,a0,702 # 62d0 <csem_free+0x27e>
...
void test_thread(){
    ...
    printf("Thread is now running\n");
      ...
      36:	2b650513          	addi	a0,a0,694 # 62e8 <csem_free+0x296>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      58:	87c78793          	addi	a5,a5,-1924 # 98d0 <uninit>
      5c:	0000c697          	auipc	a3,0xc
      60:	f8468693          	addi	a3,a3,-124 # bfe0 <buf>
    if(uninit[i] != '\0'){
      ...
      70:	8082                	ret
{
      ...
      80:	28450513          	addi	a0,a0,644 # 6300 <csem_free+0x2ae>
...
void signal_test(char *s){
    ...
    printf("Finished testing signals\n");
      ...
      f8:	22450513          	addi	a0,a0,548 # 6318 <csem_free+0x2c6>
     ...
     112:	6aa7a783          	lw	a5,1706(a5) # 87b8 <wait_sig>
     116:	ef81                	bnez	a5,12e <signal_test+0x98>
     118:	00008497          	auipc	s1,0x8
     11c:	6a048493          	addi	s1,s1,1696 # 87b8 <wait_sig>
            sleep(1);
     120:	4505                	li	a0,1
...
0000000000000138 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
     ...
     194:	1a850513          	addi	a0,a0,424 # 6338 <csem_free+0x2e6>
     ...
     1b0:	1a450513          	addi	a0,a0,420 # 6350 <csem_free+0x2fe>
     ...
     1cc:	1a050513          	addi	a0,a0,416 # 6368 <csem_free+0x316>
...
00000000000001ec <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
     ...
     244:	0f850513          	addi	a0,a0,248 # 6338 <csem_free+0x2e6>
     ...
     268:	0d450513          	addi	a0,a0,212 # 6338 <csem_free+0x2e6>
...
0000000000000286 <forkfork>:
{
    ...
    if(xstatus != 0) {
     ...
     2e2:	0aa50513          	addi	a0,a0,170 # 6388 <csem_free+0x336>
     ...
     2f4:	6fa080e7          	jalr	1786(ra) # 59ea <exit>
{
     ...
     33a:	06250513          	addi	a0,a0,98 # 6398 <csem_free+0x346>
...
0000000000000350 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    printf("%s: fork claimed to work 1000 times!\n", s);
     ...
     380:	05450513          	addi	a0,a0,84 # 63d0 <csem_free+0x37e>
  ...
  if(wait(0) != -1){
    ...
    printf("%s: no fork at all!\n", s);
     ...
     3e2:	fda50513          	addi	a0,a0,-38 # 63b8 <csem_free+0x366>
    ...
    exit(1);
     ...
     3fe:	ffe50513          	addi	a0,a0,-2 # 63f8 <csem_free+0x3a6>
    ...
    printf("%s: wait got too many\n", s);
     ...
     41a:	ffa50513          	addi	a0,a0,-6 # 6410 <csem_free+0x3be>
...
void thread_test(char *s){
    ...
    printf("Finished testing threads, main thread id: %d, %d\n", tid,status);
     ...
     488:	fa450513          	addi	a0,a0,-92 # 6428 <csem_free+0x3d6>
...
void bsem_test(char *s){
    ...
    int bid = bsem_alloc();
     ...
     4ae:	610080e7          	jalr	1552(ra) # 5aba <bsem_alloc>
     4b2:	84aa                	mv	s1,a0
    bsem_down(bid);
     4b4:	00005097          	auipc	ra,0x5
     4b8:	5ee080e7          	jalr	1518(ra) # 5aa2 <bsem_down>
    printf("1. Parent downing semaphore\n");
     4bc:	00006517          	auipc	a0,0x6
     4c0:	fa450513          	addi	a0,a0,-92 # 6460 <csem_free+0x40e>
    ...
    printf("3. Let the child wait on the semaphore...\n");
     ...
     4e8:	fd450513          	addi	a0,a0,-44 # 64b8 <csem_free+0x466>
    ...
    bsem_up(bid);
     ...
     504:	5aa080e7          	jalr	1450(ra) # 5aaa <bsem_up>
    bsem_free(bid);
     508:	8526                	mv	a0,s1
     50a:	00005097          	auipc	ra,0x5
     50e:	5a8080e7          	jalr	1448(ra) # 5ab2 <bsem_free>
    wait(&pid);
    ...
    printf("Finished bsem test, make sure that the order of the prints is alright. Meaning (1...2...3...4)\n");
     ...
     522:	fca50513          	addi	a0,a0,-54 # 64e8 <csem_free+0x496>
     ...
     53c:	f4850513          	addi	a0,a0,-184 # 6480 <csem_free+0x42e>
     540:	00006097          	auipc	ra,0x6
     544:	87c080e7          	jalr	-1924(ra) # 5dbc <printf>
        bsem_down(bid);
     548:	8526                	mv	a0,s1
     54a:	00005097          	auipc	ra,0x5
     54e:	558080e7          	jalr	1368(ra) # 5aa2 <bsem_down>
        printf("4. Child woke up\n");
     552:	00006517          	auipc	a0,0x6
     556:	f4e50513          	addi	a0,a0,-178 # 64a0 <csem_free+0x44e>
...
void Csem_test(char *s){
    ...
    retval = csem_alloc(&csem,1);
     ...
     57e:	a7a080e7          	jalr	-1414(ra) # 5ff4 <csem_alloc>
    if(retval==-1)
     582:	57fd                	li	a5,-1
    ...
    printf("1. Parent downing semaphore\n");
     ...
     598:	ecc50513          	addi	a0,a0,-308 # 6460 <csem_free+0x40e>
    ...
    printf("3. Let the child wait on the semaphore...\n");
     ...
     5c0:	efc50513          	addi	a0,a0,-260 # 64b8 <csem_free+0x466>
    ...
    csem_up(&csem);
     ...
     5de:	9d4080e7          	jalr	-1580(ra) # 5fae <csem_up>
    csem_free(&csem);
     5e2:	fe040513          	addi	a0,s0,-32
     5e6:	00006097          	auipc	ra,0x6
     5ea:	a6c080e7          	jalr	-1428(ra) # 6052 <csem_free>
    wait(&pid);
    ...
    printf("Finished bsem test, make sure that the order of the prints is alright. Meaning (1...2...3...4)\n");
     ...
     5fe:	eee50513          	addi	a0,a0,-274 # 64e8 <csem_free+0x496>
     ...
     616:	f3650513          	addi	a0,a0,-202 # 6548 <csem_free+0x4f6>
     ...
     630:	e5450513          	addi	a0,a0,-428 # 6480 <csem_free+0x42e>
     ...
     64c:	e5850513          	addi	a0,a0,-424 # 64a0 <csem_free+0x44e>
...
0000000000000662 <copyinstr1>:
{
    ...
    uint64 addr = addrs[ai];
     ...
     6a4:	ec050513          	addi	a0,a0,-320 # 6560 <csem_free+0x50e>
...
00000000000006ba <opentest>:
{
  ...
  fd = open("echo", 0);
     ...
     6cc:	eb850513          	addi	a0,a0,-328 # 6580 <csem_free+0x52e>
  ...
  fd = open("doesnotexist", 0);
     ...
     6ea:	eba50513          	addi	a0,a0,-326 # 65a0 <csem_free+0x54e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
     ...
     70a:	e8250513          	addi	a0,a0,-382 # 6588 <csem_free+0x536>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     726:	e8e50513          	addi	a0,a0,-370 # 65b0 <csem_free+0x55e>
...
000000000000073c <truncate2>:
{
  ...
  int n = write(fd1, "x", 1);
     ...
     7a0:	e5458593          	addi	a1,a1,-428 # 65f0 <csem_free+0x59e>
     7a4:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     7b8:	e2450513          	addi	a0,a0,-476 # 65d8 <csem_free+0x586>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     7ee:	e0e50513          	addi	a0,a0,-498 # 65f8 <csem_free+0x5a6>
...
0000000000000804 <forkforkfork>:
{
  ...
  unlink("stopforking");
     ...
     814:	e1050513          	addi	a0,a0,-496 # 6620 <csem_free+0x5ce>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
     ...
     840:	de450513          	addi	a0,a0,-540 # 6620 <csem_free+0x5ce>
  ...
  sleep(10); // one second
    ...
    printf("%s: fork failed", s);
     ...
     878:	b1450513          	addi	a0,a0,-1260 # 6388 <csem_free+0x336>
    ...
    exit(1);
     ...
     892:	d9248493          	addi	s1,s1,-622 # 6620 <csem_free+0x5ce>
     896:	4581                	li	a1,0
     898:	8526                	mv	a0,s1
...
00000000000008d4 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     8f0:	92450513          	addi	a0,a0,-1756 # 6210 <csem_free+0x1be>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     904:	910a8a93          	addi	s5,s5,-1776 # 6210 <csem_free+0x1be>
      int cc = write(fd, buf, sz);
     908:	0000ba17          	auipc	s4,0xb
     90c:	6d8a0a13          	addi	s4,s4,1752 # bfe0 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     910:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     986:	cae50513          	addi	a0,a0,-850 # 6630 <csem_free+0x5de>
     ...
     9aa:	caa50513          	addi	a0,a0,-854 # 6650 <csem_free+0x5fe>
...
00000000000009c0 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     9e6:	c86a0a13          	addi	s4,s4,-890 # 6668 <csem_free+0x616>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     a92:	be250513          	addi	a0,a0,-1054 # 6670 <csem_free+0x61e>
     ...
     ab0:	bdc50513          	addi	a0,a0,-1060 # 6688 <csem_free+0x636>
     ...
     ace:	bee50513          	addi	a0,a0,-1042 # 66b8 <csem_free+0x666>
     ...
     ae8:	c0450513          	addi	a0,a0,-1020 # 66e8 <csem_free+0x696>
     ...
     b06:	bf650513          	addi	a0,a0,-1034 # 66f8 <csem_free+0x6a6>
...
0000000000000b1c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     b44:	be8a0a13          	addi	s4,s4,-1048 # 6728 <csem_free+0x6d6>
    n = write(fds[1], "x", 1);
     b48:	00006a97          	auipc	s5,0x6
     b4c:	aa8a8a93          	addi	s5,s5,-1368 # 65f0 <csem_free+0x59e>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     bf2:	b4250513          	addi	a0,a0,-1214 # 6730 <csem_free+0x6de>
     ...
     c10:	b3c50513          	addi	a0,a0,-1220 # 6748 <csem_free+0x6f6>
     ...
     c2a:	ac250513          	addi	a0,a0,-1342 # 66e8 <csem_free+0x696>
     ...
     c44:	b3850513          	addi	a0,a0,-1224 # 6778 <csem_free+0x726>
     ...
     c62:	b3250513          	addi	a0,a0,-1230 # 6790 <csem_free+0x73e>
...
0000000000000c78 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     cb8:	93458593          	addi	a1,a1,-1740 # 65e8 <csem_free+0x596>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     cd4:	90850513          	addi	a0,a0,-1784 # 65d8 <csem_free+0x586>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     d00:	8dc50513          	addi	a0,a0,-1828 # 65d8 <csem_free+0x586>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     d14:	8c850513          	addi	a0,a0,-1848 # 65d8 <csem_free+0x586>
  ...
  write(fd1, "abcdef", 6);
     ...
     d52:	ad258593          	addi	a1,a1,-1326 # 6820 <csem_free+0x7ce>
     d56:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     d94:	84850513          	addi	a0,a0,-1976 # 65d8 <csem_free+0x586>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     dd8:	9ec50513          	addi	a0,a0,-1556 # 67c0 <csem_free+0x76e>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     df4:	9f050513          	addi	a0,a0,-1552 # 67e0 <csem_free+0x78e>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     e08:	9ec50513          	addi	a0,a0,-1556 # 67f0 <csem_free+0x79e>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     e24:	9f050513          	addi	a0,a0,-1552 # 6810 <csem_free+0x7be>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     e38:	9bc50513          	addi	a0,a0,-1604 # 67f0 <csem_free+0x79e>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     e56:	9d650513          	addi	a0,a0,-1578 # 6828 <csem_free+0x7d6>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     e74:	9d850513          	addi	a0,a0,-1576 # 6848 <csem_free+0x7f6>
...
0000000000000e8a <pipe1>:
{
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ed6:	10ea8a93          	addi	s5,s5,270 # bfe0 <buf>
      if(cc > sizeof(buf))
     eda:	6b0d                	lui	s6,0x3
    while((n = read(fds[0], buf, cc)) > 0){
     edc:	864e                	mv	a2,s3
     ...
     ef4:	0f070713          	addi	a4,a4,240 # bfe0 <buf>
    ...
    printf("%s: pipe() failed\n", s);
     ...
     f2c:	94050513          	addi	a0,a0,-1728 # 6868 <csem_free+0x816>
    ...
    for(n = 0; n < N; n++){
     ...
     f52:	092b0b13          	addi	s6,s6,146 # bfe0 <buf>
     ...
     f66:	42da8a93          	addi	s5,s5,1069 # 142d <linktest+0x77>
{
    ...
    exit(0);
     ...
     fb2:	8d250513          	addi	a0,a0,-1838 # 6880 <csem_free+0x82e>
     ...
     fce:	8ce50513          	addi	a0,a0,-1842 # 6898 <csem_free+0x846>
    ...
    1000:	8b450513          	addi	a0,a0,-1868 # 68b0 <csem_free+0x85e>
    ...
    1040:	89450513          	addi	a0,a0,-1900 # 68d0 <csem_free+0x87e>
...
0000000000001056 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    1080:	30c50513          	addi	a0,a0,780 # 6388 <csem_free+0x336>
  ...
  if(pid2 == 0)
    ...
    10ae:	28e50513          	addi	a0,a0,654 # 6338 <csem_free+0x2e6>
  ...
  if(pid3 == 0){
    ...
    10f2:	50258593          	addi	a1,a1,1282 # 65f0 <csem_free+0x59e>
    ...
    111c:	22050513          	addi	a0,a0,544 # 6338 <csem_free+0x2e6>
    ...
    1138:	7b450513          	addi	a0,a0,1972 # 68e8 <csem_free+0x896>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    1158:	e8c58593          	addi	a1,a1,-372 # bfe0 <buf>
    ...
    1174:	79050513          	addi	a0,a0,1936 # 6900 <csem_free+0x8ae>
  ...
  printf("kill... ");
    ...
    11a0:	77c50513          	addi	a0,a0,1916 # 6918 <csem_free+0x8c6>
  ...
  printf("wait... ");
    ...
    11d4:	75850513          	addi	a0,a0,1880 # 6928 <csem_free+0x8d6>
...
0000000000001200 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1218:	fac50513          	addi	a0,a0,-84 # 61c0 <csem_free+0x16e>
  ...
  write(fd, "hello", SZ);
    ...
    1230:	72c58593          	addi	a1,a1,1836 # 6958 <csem_free+0x906>
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    124c:	f7850513          	addi	a0,a0,-136 # 61c0 <csem_free+0x16e>
  ...
  if(unlink("unlinkread") != 0){
    ...
    1262:	f6250513          	addi	a0,a0,-158 # 61c0 <csem_free+0x16e>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1278:	f4c50513          	addi	a0,a0,-180 # 61c0 <csem_free+0x16e>
  ...
  write(fd1, "yyy", 3);
    ...
    128c:	71858593          	addi	a1,a1,1816 # 69a0 <csem_free+0x94e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    12a8:	d3c58593          	addi	a1,a1,-708 # bfe0 <buf>
    12ac:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
    ...
    12f4:	ed050513          	addi	a0,a0,-304 # 61c0 <csem_free+0x16e>
    ...
    1314:	62850513          	addi	a0,a0,1576 # 6938 <csem_free+0x8e6>
    ...
    1330:	63450513          	addi	a0,a0,1588 # 6960 <csem_free+0x90e>
    ...
    134c:	63850513          	addi	a0,a0,1592 # 6980 <csem_free+0x92e>
    ...
    1368:	64450513          	addi	a0,a0,1604 # 69a8 <csem_free+0x956>
    ...
    1384:	64850513          	addi	a0,a0,1608 # 69c8 <csem_free+0x976>
    ...
    13a0:	64c50513          	addi	a0,a0,1612 # 69e8 <csem_free+0x996>
...
00000000000013b6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    1404:	55858593          	addi	a1,a1,1368 # 6958 <csem_free+0x906>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    1424:	5f058593          	addi	a1,a1,1520 # 6a10 <csem_free+0x9be>
    1428:	00005517          	auipc	a0,0x5
    142c:	5e050513          	addi	a0,a0,1504 # 6a08 <csem_free+0x9b6>
  ...
  unlink("lf1");
    ...
    1440:	5cc50513          	addi	a0,a0,1484 # 6a08 <csem_free+0x9b6>
    1444:	00004097          	auipc	ra,0x4
    1448:	5f6080e7          	jalr	1526(ra) # 5a3a <unlink>
  if(open("lf1", 0) >= 0){
    144c:	4581                	li	a1,0
    144e:	00005517          	auipc	a0,0x5
    1452:	5ba50513          	addi	a0,a0,1466 # 6a08 <csem_free+0x9b6>
  ...
  fd = open("lf2", 0);
    ...
    1468:	5ac50513          	addi	a0,a0,1452 # 6a10 <csem_free+0x9be>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    1480:	b6458593          	addi	a1,a1,-1180 # bfe0 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    14a0:	57458593          	addi	a1,a1,1396 # 6a10 <csem_free+0x9be>
    14a4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
    ...
    14b6:	55e50513          	addi	a0,a0,1374 # 6a10 <csem_free+0x9be>
    14ba:	00004097          	auipc	ra,0x4
    14be:	580080e7          	jalr	1408(ra) # 5a3a <unlink>
  if(link("lf2", "lf1") >= 0){
    14c2:	00005597          	auipc	a1,0x5
    14c6:	54658593          	addi	a1,a1,1350 # 6a08 <csem_free+0x9b6>
    14ca:	00005517          	auipc	a0,0x5
    14ce:	54650513          	addi	a0,a0,1350 # 6a10 <csem_free+0x9be>
  ...
  if(link(".", "lf1") >= 0){
    ...
    14e2:	52a58593          	addi	a1,a1,1322 # 6a08 <csem_free+0x9b6>
    14e6:	00005517          	auipc	a0,0x5
    14ea:	63250513          	addi	a0,a0,1586 # 6b18 <csem_free+0xac6>
    ...
    150c:	51050513          	addi	a0,a0,1296 # 6a18 <csem_free+0x9c6>
    ...
    1528:	50c50513          	addi	a0,a0,1292 # 6a30 <csem_free+0x9de>
    ...
    1544:	50850513          	addi	a0,a0,1288 # 6a48 <csem_free+0x9f6>
    ...
    1560:	50c50513          	addi	a0,a0,1292 # 6a68 <csem_free+0xa16>
    ...
    157c:	52050513          	addi	a0,a0,1312 # 6a98 <csem_free+0xa46>
    ...
    1598:	51c50513          	addi	a0,a0,1308 # 6ab0 <csem_free+0xa5e>
    ...
    15b4:	51850513          	addi	a0,a0,1304 # 6ac8 <csem_free+0xa76>
    ...
    15d0:	52450513          	addi	a0,a0,1316 # 6af0 <csem_free+0xa9e>
    ...
    15ec:	53850513          	addi	a0,a0,1336 # 6b20 <csem_free+0xace>
...
0000000000001602 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    161e:	52698993          	addi	s3,s3,1318 # 6b40 <csem_free+0xaee>
    1622:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    165a:	4fa50513          	addi	a0,a0,1274 # 6b50 <csem_free+0xafe>
...
0000000000001670 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    16d2:	25a78793          	addi	a5,a5,602 # 7928 <csem_free+0x18d6>
  ...
  if(pid == 0){
    ...
    1708:	1c478793          	addi	a5,a5,452 # 88c8 <big.0>
    170c:	00008697          	auipc	a3,0x8
    1710:	1bc68693          	addi	a3,a3,444 # 98c8 <__global_pointer$+0x920>
      big[i] = 'x';
    ...
    1726:	1a078323          	sb	zero,422(a5) # 98c8 <__global_pointer$+0x920>
    char *args2[] = { big, big, big, 0 };
    172a:	00007797          	auipc	a5,0x7
    172e:	d8e78793          	addi	a5,a5,-626 # 84b8 <csem_free+0x2466>
    ...
    1752:	e3250513          	addi	a0,a0,-462 # 6580 <csem_free+0x52e>
    ...
    176a:	49250513          	addi	a0,a0,1170 # 6bf8 <csem_free+0xba6>
    ...
    178a:	3ea50513          	addi	a0,a0,1002 # 6b70 <csem_free+0xb1e>
    ...
    17aa:	3ea50513          	addi	a0,a0,1002 # 6b90 <csem_free+0xb3e>
    ...
    17cc:	3e850513          	addi	a0,a0,1000 # 6bb0 <csem_free+0xb5e>
    ...
    17ec:	3f050513          	addi	a0,a0,1008 # 6bd8 <csem_free+0xb86>
    ...
    1806:	5fe50513          	addi	a0,a0,1534 # 6e00 <csem_free+0xdae>
  ...
  if(st != 747){
    ...
    1850:	3d450513          	addi	a0,a0,980 # 6c20 <csem_free+0xbce>
...
0000000000001866 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1878:	d0c78793          	addi	a5,a5,-756 # 6580 <csem_free+0x52e>
    187c:	fcf43023          	sd	a5,-64(s0)
    1880:	00005797          	auipc	a5,0x5
    1884:	3d078793          	addi	a5,a5,976 # 6c50 <csem_free+0xbfe>
    1888:	fcf43423          	sd	a5,-56(s0)
    188c:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1890:	00005517          	auipc	a0,0x5
    1894:	3c850513          	addi	a0,a0,968 # 6c58 <csem_free+0xc06>
  ...
  if(pid == 0) {
    ...
    18c2:	39a50513          	addi	a0,a0,922 # 6c58 <csem_free+0xc06>
    ...
    18de:	39e50513          	addi	a0,a0,926 # 6c78 <csem_free+0xc26>
    ...
    18fa:	a4250513          	addi	a0,a0,-1470 # 6338 <csem_free+0x2e6>
    ...
    1916:	34e50513          	addi	a0,a0,846 # 6c60 <csem_free+0xc0e>
    ...
    1934:	c5050513          	addi	a0,a0,-944 # 6580 <csem_free+0x52e>
  ...
  if(xstatus != 0)
    ...
    1968:	32450513          	addi	a0,a0,804 # 6c88 <csem_free+0xc36>
    ...
    1984:	32050513          	addi	a0,a0,800 # 6ca0 <csem_free+0xc4e>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1998:	2c450513          	addi	a0,a0,708 # 6c58 <csem_free+0xc06>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    19c2:	31250513          	addi	a0,a0,786 # 6cd0 <csem_free+0xc7e>
    ...
    19de:	2de50513          	addi	a0,a0,734 # 6cb8 <csem_free+0xc66>
  ...
  unlink("echo-ok");
    ...
    19f8:	26450513          	addi	a0,a0,612 # 6c58 <csem_free+0xc06>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1a22:	2ca50513          	addi	a0,a0,714 # 6ce8 <csem_free+0xc96>
...
bigargtest(char *s)
{
  ...
  unlink("bigarg-ok");
    ...
    1a52:	2b250513          	addi	a0,a0,690 # 6d00 <csem_free+0xcae>
  ...
  fd = open("bigarg-ok", 0);
    ...
    1a84:	28050513          	addi	a0,a0,640 # 6d00 <csem_free+0xcae>
  ...
  close(fd);
    ...
    1aaa:	d2278793          	addi	a5,a5,-734 # 87c8 <args.1>
    1aae:	00007697          	auipc	a3,0x7
    1ab2:	e1268693          	addi	a3,a3,-494 # 88c0 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    1ab6:	00005717          	auipc	a4,0x5
    1aba:	25a70713          	addi	a4,a4,602 # 6d10 <csem_free+0xcbe>
    ...
    1b0e:	2e650513          	addi	a0,a0,742 # 6df0 <csem_free+0xd9e>
    ...
    1b32:	2e250513          	addi	a0,a0,738 # 6e10 <csem_free+0xdbe>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1b5a:	c524b483          	ld	s1,-942(s1) # 87a8 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    1b90:	35048493          	addi	s1,s1,848 # c350 <buf+0x370>
  for(int i = 0; i < 50000; i++){
    ...
    1b9e:	9e698993          	addi	s3,s3,-1562 # 6580 <csem_free+0x52e>
    argv[0] = (char*)0xffffffff;
...
0000000000001bc6 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1c40:	cec78793          	addi	a5,a5,-788 # 7928 <csem_free+0x18d6>
  ...
  if(ret != -1){
    ...
    1c82:	1b250513          	addi	a0,a0,434 # 6e30 <csem_free+0xdde>
    ...
    1ca0:	ed450513          	addi	a0,a0,-300 # 6b70 <csem_free+0xb1e>
    ...
    1cbe:	ed650513          	addi	a0,a0,-298 # 6b90 <csem_free+0xb3e>
    ...
    1cde:	ed650513          	addi	a0,a0,-298 # 6bb0 <csem_free+0xb5e>
    ...
    1cfc:	ee050513          	addi	a0,a0,-288 # 6bd8 <csem_free+0xb86>
...
0000000000001d12 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1d48:	3e450513          	addi	a0,a0,996 # 6128 <csem_free+0xd6>
  ...
  if(n >= 0){
    ...
    1d7a:	11250513          	addi	a0,a0,274 # 6e88 <csem_free+0xe36>
    ...
    1d94:	0a850513          	addi	a0,a0,168 # 6e38 <csem_free+0xde6>
    ...
    1dae:	0a650513          	addi	a0,a0,166 # 6e50 <csem_free+0xdfe>
    ...
    1dc8:	0ac50513          	addi	a0,a0,172 # 6e70 <csem_free+0xe1e>
  ...
  unlink("rwsbrk");
    ...
    1dec:	34050513          	addi	a0,a0,832 # 6128 <csem_free+0xd6>
    1df0:	00004097          	auipc	ra,0x4
    1df4:	c4a080e7          	jalr	-950(ra) # 5a3a <unlink>
  fd = open("README", O_RDONLY);
    1df8:	4581                	li	a1,0
    1dfa:	00005517          	auipc	a0,0x5
    1dfe:	92e50513          	addi	a0,a0,-1746 # 6728 <csem_free+0x6d6>
  ...
  if(n >= 0){
    ...
    1e28:	09450513          	addi	a0,a0,148 # 6eb8 <csem_free+0xe66>
    ...
    1e42:	03250513          	addi	a0,a0,50 # 6e70 <csem_free+0xe1e>
...
0000000000001e6c <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    1e90:	05450513          	addi	a0,a0,84 # 6ee0 <csem_free+0xe8e>
    1e94:	00004097          	auipc	ra,0x4
    1e98:	b96080e7          	jalr	-1130(ra) # 5a2a <open>
    1e9c:	84aa                	mv	s1,a0
  unlink("sbrk");
    1e9e:	00005517          	auipc	a0,0x5
    1ea2:	04250513          	addi	a0,a0,66 # 6ee0 <csem_free+0xe8e>
  ...
  if(pipe((int *) a) != 0){
    ...
    1ef6:	ff650513          	addi	a0,a0,-10 # 6ee8 <csem_free+0xe96>
    ...
    1f12:	ff250513          	addi	a0,a0,-14 # 6f00 <csem_free+0xeae>
    ...
    1f2e:	93e50513          	addi	a0,a0,-1730 # 6868 <csem_free+0x816>
...
0000000000001f44 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    1f58:	fc450513          	addi	a0,a0,-60 # 6f18 <csem_free+0xec6>
  ...
  close(fd);
    ...
    1fa0:	d1c50513          	addi	a0,a0,-740 # 6cb8 <csem_free+0xc66>
...
0000000000001fb6 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    1fc6:	f5e50513          	addi	a0,a0,-162 # 6f20 <csem_free+0xece>
  ...
  if(pid == 0){
    ...
    1fea:	f3a50513          	addi	a0,a0,-198 # 6f20 <csem_free+0xece>
    ...
    2000:	f4450513          	addi	a0,a0,-188 # 6f40 <csem_free+0xeee>
    ...
    201c:	f1050513          	addi	a0,a0,-240 # 6f28 <csem_free+0xed6>
    ...
    2038:	30450513          	addi	a0,a0,772 # 6338 <csem_free+0x2e6>
  ...
  if(unlink("oidir") != 0){
    ...
    2066:	ebe50513          	addi	a0,a0,-322 # 6f20 <csem_free+0xece>
    ...
    207a:	ef250513          	addi	a0,a0,-270 # 6f68 <csem_free+0xf16>
...
00000000000020a8 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    20b8:	09c50513          	addi	a0,a0,156 # 7150 <csem_free+0x10fe>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    20ca:	ee250513          	addi	a0,a0,-286 # 6fa8 <csem_free+0xf56>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    20e0:	f2450513          	addi	a0,a0,-220 # 7000 <csem_free+0xfae>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    20fe:	f7e50513          	addi	a0,a0,-130 # 7078 <csem_free+0x1026>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    211a:	fd250513          	addi	a0,a0,-46 # 70e8 <csem_free+0x1096>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    212c:	01850513          	addi	a0,a0,24 # 7140 <csem_free+0x10ee>
  ...
  unlink("12345678901234");
    ...
    21aa:	dda50513          	addi	a0,a0,-550 # 6f80 <csem_free+0xf2e>
    ...
    21c6:	e0650513          	addi	a0,a0,-506 # 6fc8 <csem_free+0xf76>
    ...
    21e2:	e5250513          	addi	a0,a0,-430 # 7030 <csem_free+0xfde>
    ...
    21fe:	eae50513          	addi	a0,a0,-338 # 70a8 <csem_free+0x1056>
    ...
    221a:	ef250513          	addi	a0,a0,-270 # 7108 <csem_free+0x10b6>
    ...
    2236:	f2e50513          	addi	a0,a0,-210 # 7160 <csem_free+0x110e>
...
000000000000224c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    225c:	f4050513          	addi	a0,a0,-192 # 7198 <csem_free+0x1146>
  ...
  if(chdir("iputdir") < 0){
    ...
    2270:	f2c50513          	addi	a0,a0,-212 # 7198 <csem_free+0x1146>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2284:	f5850513          	addi	a0,a0,-168 # 71d8 <csem_free+0x1186>
  ...
  if(chdir("/") < 0){
    ...
    2298:	f7450513          	addi	a0,a0,-140 # 7208 <csem_free+0x11b6>
    ...
    22b8:	eec50513          	addi	a0,a0,-276 # 71a0 <csem_free+0x114e>
    ...
    22d4:	ee850513          	addi	a0,a0,-280 # 71b8 <csem_free+0x1166>
    ...
    22f0:	efc50513          	addi	a0,a0,-260 # 71e8 <csem_free+0x1196>
    ...
    230c:	f0850513          	addi	a0,a0,-248 # 7210 <csem_free+0x11be>
...
0000000000002322 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2340:	e5c50513          	addi	a0,a0,-420 # 7198 <csem_free+0x1146>
    ...
    2354:	e4850513          	addi	a0,a0,-440 # 7198 <csem_free+0x1146>
    ...
    2368:	e7450513          	addi	a0,a0,-396 # 71d8 <csem_free+0x1186>
    ...
    2388:	fb450513          	addi	a0,a0,-76 # 6338 <csem_free+0x2e6>
    ...
    23a4:	e0050513          	addi	a0,a0,-512 # 71a0 <csem_free+0x114e>
    ...
    23c0:	e6c50513          	addi	a0,a0,-404 # 7228 <csem_free+0x11d6>
    ...
    23dc:	e1050513          	addi	a0,a0,-496 # 71e8 <csem_free+0x1196>
...
000000000000240a <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    241a:	e2a50513          	addi	a0,a0,-470 # 7240 <csem_free+0x11ee>
  ...
  if(chdir("dir0") < 0){
    ...
    242e:	e1650513          	addi	a0,a0,-490 # 7240 <csem_free+0x11ee>
  ...
  if(chdir("..") < 0){
    ...
    2442:	e2250513          	addi	a0,a0,-478 # 7260 <csem_free+0x120e>
  ...
  if(unlink("dir0") < 0){
    ...
    2456:	dee50513          	addi	a0,a0,-530 # 7240 <csem_free+0x11ee>
    ...
    2476:	d2e50513          	addi	a0,a0,-722 # 71a0 <csem_free+0x114e>
    ...
    2492:	dba50513          	addi	a0,a0,-582 # 7248 <csem_free+0x11f6>
    ...
    24ae:	dbe50513          	addi	a0,a0,-578 # 7268 <csem_free+0x1216>
    ...
    24ca:	dba50513          	addi	a0,a0,-582 # 7280 <csem_free+0x122e>
...
00000000000024e0 <subdir>:
{
  ...
  unlink("ff");
    ...
    24f2:	eda50513          	addi	a0,a0,-294 # 73c8 <csem_free+0x1376>
    24f6:	00003097          	auipc	ra,0x3
    24fa:	544080e7          	jalr	1348(ra) # 5a3a <unlink>
  if(mkdir("dd") != 0){
    24fe:	00005517          	auipc	a0,0x5
    2502:	d9a50513          	addi	a0,a0,-614 # 7298 <csem_free+0x1246>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    251a:	da250513          	addi	a0,a0,-606 # 72b8 <csem_free+0x1266>
  ...
  write(fd, "ff", 2);
    ...
    2532:	e9a58593          	addi	a1,a1,-358 # 73c8 <csem_free+0x1376>
  ...
  if(unlink("dd") >= 0){
    ...
    254c:	d5050513          	addi	a0,a0,-688 # 7298 <csem_free+0x1246>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2560:	db450513          	addi	a0,a0,-588 # 7310 <csem_free+0x12be>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2578:	dc450513          	addi	a0,a0,-572 # 7338 <csem_free+0x12e6>
  ...
  write(fd, "FF", 2);
    ...
    2590:	ddc58593          	addi	a1,a1,-548 # 7368 <csem_free+0x1316>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    25ac:	dc850513          	addi	a0,a0,-568 # 7370 <csem_free+0x131e>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    25c4:	a2058593          	addi	a1,a1,-1504 # bfe0 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    25da:	a0a74703          	lbu	a4,-1526(a4) # bfe0 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    25f4:	dd058593          	addi	a1,a1,-560 # 73c0 <csem_free+0x136e>
    25f8:	00005517          	auipc	a0,0x5
    25fc:	d4050513          	addi	a0,a0,-704 # 7338 <csem_free+0x12e6>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2610:	d2c50513          	addi	a0,a0,-724 # 7338 <csem_free+0x12e6>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2626:	d1650513          	addi	a0,a0,-746 # 7338 <csem_free+0x12e6>
  ...
  if(chdir("dd") != 0){
    ...
    263a:	c6250513          	addi	a0,a0,-926 # 7298 <csem_free+0x1246>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    264e:	e0e50513          	addi	a0,a0,-498 # 7458 <csem_free+0x1406>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2662:	e2a50513          	addi	a0,a0,-470 # 7488 <csem_free+0x1436>
  ...
  if(chdir("./..") != 0){
    ...
    2676:	e4650513          	addi	a0,a0,-442 # 74b8 <csem_free+0x1466>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    268c:	d3850513          	addi	a0,a0,-712 # 73c0 <csem_free+0x136e>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    26a4:	94058593          	addi	a1,a1,-1728 # bfe0 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    26c6:	c7650513          	addi	a0,a0,-906 # 7338 <csem_free+0x12e6>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    26de:	e6e50513          	addi	a0,a0,-402 # 7548 <csem_free+0x14f6>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    26f6:	e8650513          	addi	a0,a0,-378 # 7578 <csem_free+0x1526>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    270e:	b8e50513          	addi	a0,a0,-1138 # 7298 <csem_free+0x1246>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2724:	b7850513          	addi	a0,a0,-1160 # 7298 <csem_free+0x1246>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    273a:	b6250513          	addi	a0,a0,-1182 # 7298 <csem_free+0x1246>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    274e:	ebe58593          	addi	a1,a1,-322 # 7608 <csem_free+0x15b6>
    2752:	00005517          	auipc	a0,0x5
    2756:	df650513          	addi	a0,a0,-522 # 7548 <csem_free+0x14f6>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    276a:	ea258593          	addi	a1,a1,-350 # 7608 <csem_free+0x15b6>
    276e:	00005517          	auipc	a0,0x5
    2772:	e0a50513          	addi	a0,a0,-502 # 7578 <csem_free+0x1526>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2786:	c3e58593          	addi	a1,a1,-962 # 73c0 <csem_free+0x136e>
    278a:	00005517          	auipc	a0,0x5
    278e:	b2e50513          	addi	a0,a0,-1234 # 72b8 <csem_free+0x1266>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    27a2:	daa50513          	addi	a0,a0,-598 # 7548 <csem_free+0x14f6>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    27b6:	dc650513          	addi	a0,a0,-570 # 7578 <csem_free+0x1526>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    27ca:	bfa50513          	addi	a0,a0,-1030 # 73c0 <csem_free+0x136e>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    27de:	d9e50513          	addi	a0,a0,-610 # 7578 <csem_free+0x1526>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    27f2:	d5a50513          	addi	a0,a0,-678 # 7548 <csem_free+0x14f6>
  ...
  if(chdir("dd/ff") == 0){
    ...
    2806:	ab650513          	addi	a0,a0,-1354 # 72b8 <csem_free+0x1266>
  ...
  if(chdir("dd/xx") == 0){
    ...
    281a:	f4250513          	addi	a0,a0,-190 # 7758 <csem_free+0x1706>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    282e:	b9650513          	addi	a0,a0,-1130 # 73c0 <csem_free+0x136e>
  ...
  if(unlink("dd/ff") != 0){
    ...
    2842:	a7a50513          	addi	a0,a0,-1414 # 72b8 <csem_free+0x1266>
  ...
  if(unlink("dd") == 0){
    ...
    2856:	a4650513          	addi	a0,a0,-1466 # 7298 <csem_free+0x1246>
  ...
  if(unlink("dd/dd") < 0){
    ...
    286a:	f6250513          	addi	a0,a0,-158 # 77c8 <csem_free+0x1776>
  ...
  if(unlink("dd") < 0){
    ...
    287e:	a1e50513          	addi	a0,a0,-1506 # 7298 <csem_free+0x1246>
    ...
    28a0:	a0450513          	addi	a0,a0,-1532 # 72a0 <csem_free+0x124e>
    ...
    28bc:	a0850513          	addi	a0,a0,-1528 # 72c0 <csem_free+0x126e>
    ...
    28d8:	a0c50513          	addi	a0,a0,-1524 # 72e0 <csem_free+0x128e>
    ...
    28f4:	a2850513          	addi	a0,a0,-1496 # 7318 <csem_free+0x12c6>
    ...
    2910:	a3c50513          	addi	a0,a0,-1476 # 7348 <csem_free+0x12f6>
    ...
    292c:	a5850513          	addi	a0,a0,-1448 # 7380 <csem_free+0x132e>
    ...
    2948:	a5c50513          	addi	a0,a0,-1444 # 73a0 <csem_free+0x134e>
    ...
    2964:	a7050513          	addi	a0,a0,-1424 # 73d0 <csem_free+0x137e>
    ...
    2980:	a7c50513          	addi	a0,a0,-1412 # 73f8 <csem_free+0x13a6>
    ...
    299c:	a8050513          	addi	a0,a0,-1408 # 7418 <csem_free+0x13c6>
    ...
    29b8:	a8c50513          	addi	a0,a0,-1396 # 7440 <csem_free+0x13ee>
    ...
    29d4:	a9850513          	addi	a0,a0,-1384 # 7468 <csem_free+0x1416>
    ...
    29f0:	aac50513          	addi	a0,a0,-1364 # 7498 <csem_free+0x1446>
    ...
    2a0c:	ab850513          	addi	a0,a0,-1352 # 74c0 <csem_free+0x146e>
    ...
    2a28:	ab450513          	addi	a0,a0,-1356 # 74d8 <csem_free+0x1486>
    ...
    2a44:	ab850513          	addi	a0,a0,-1352 # 74f8 <csem_free+0x14a6>
    ...
    2a60:	abc50513          	addi	a0,a0,-1348 # 7518 <csem_free+0x14c6>
    ...
    2a7c:	ae050513          	addi	a0,a0,-1312 # 7558 <csem_free+0x1506>
    ...
    2a98:	af450513          	addi	a0,a0,-1292 # 7588 <csem_free+0x1536>
    ...
    2ab4:	af850513          	addi	a0,a0,-1288 # 75a8 <csem_free+0x1556>
    ...
    2ad0:	afc50513          	addi	a0,a0,-1284 # 75c8 <csem_free+0x1576>
    ...
    2aec:	b0050513          	addi	a0,a0,-1280 # 75e8 <csem_free+0x1596>
    ...
    2b08:	b1450513          	addi	a0,a0,-1260 # 7618 <csem_free+0x15c6>
    ...
    2b24:	b2050513          	addi	a0,a0,-1248 # 7640 <csem_free+0x15ee>
    ...
    2b40:	b2c50513          	addi	a0,a0,-1236 # 7668 <csem_free+0x1616>
    ...
    2b5c:	b3850513          	addi	a0,a0,-1224 # 7690 <csem_free+0x163e>
    ...
    2b78:	b3c50513          	addi	a0,a0,-1220 # 76b0 <csem_free+0x165e>
    ...
    2b94:	b4050513          	addi	a0,a0,-1216 # 76d0 <csem_free+0x167e>
    ...
    2bb0:	b4c50513          	addi	a0,a0,-1204 # 76f8 <csem_free+0x16a6>
    ...
    2bcc:	b5050513          	addi	a0,a0,-1200 # 7718 <csem_free+0x16c6>
    ...
    2be8:	b5450513          	addi	a0,a0,-1196 # 7738 <csem_free+0x16e6>
    ...
    2c04:	b6050513          	addi	a0,a0,-1184 # 7760 <csem_free+0x170e>
    ...
    2c20:	7dc50513          	addi	a0,a0,2012 # 73f8 <csem_free+0x13a6>
    ...
    2c3c:	b4850513          	addi	a0,a0,-1208 # 7780 <csem_free+0x172e>
    ...
    2c58:	b4c50513          	addi	a0,a0,-1204 # 77a0 <csem_free+0x174e>
    ...
    2c74:	b6050513          	addi	a0,a0,-1184 # 77d0 <csem_free+0x177e>
    ...
    2c90:	b6450513          	addi	a0,a0,-1180 # 77f0 <csem_free+0x179e>
...
0000000000002ca6 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2cb6:	b5650513          	addi	a0,a0,-1194 # 7808 <csem_free+0x17b6>
  ...
  if(chdir("dots") != 0){
    ...
    2cc8:	b4450513          	addi	a0,a0,-1212 # 7808 <csem_free+0x17b6>
  ...
  if(unlink(".") == 0){
    ...
    2cda:	e4250513          	addi	a0,a0,-446 # 6b18 <csem_free+0xac6>
  ...
  if(unlink("..") == 0){
    ...
    2cec:	57850513          	addi	a0,a0,1400 # 7260 <csem_free+0x120e>
  ...
  if(chdir("/") != 0){
    ...
    2cfe:	50e50513          	addi	a0,a0,1294 # 7208 <csem_free+0x11b6>
  ...
  if(unlink("dots/.") == 0){
    ...
    2d10:	b6450513          	addi	a0,a0,-1180 # 7870 <csem_free+0x181e>
  ...
  if(unlink("dots/..") == 0){
    ...
    2d22:	b7a50513          	addi	a0,a0,-1158 # 7898 <csem_free+0x1846>
  ...
  if(unlink("dots") != 0){
    ...
    2d34:	ad850513          	addi	a0,a0,-1320 # 7808 <csem_free+0x17b6>
    ...
    2d52:	ac250513          	addi	a0,a0,-1342 # 7810 <csem_free+0x17be>
    ...
    2d6e:	abe50513          	addi	a0,a0,-1346 # 7828 <csem_free+0x17d6>
    ...
    2d8a:	aba50513          	addi	a0,a0,-1350 # 7840 <csem_free+0x17ee>
    ...
    2da6:	ab650513          	addi	a0,a0,-1354 # 7858 <csem_free+0x1806>
    ...
    2dc2:	45250513          	addi	a0,a0,1106 # 7210 <csem_free+0x11be>
    ...
    2dde:	a9e50513          	addi	a0,a0,-1378 # 7878 <csem_free+0x1826>
    ...
    2dfa:	aaa50513          	addi	a0,a0,-1366 # 78a0 <csem_free+0x184e>
    ...
    2e16:	aae50513          	addi	a0,a0,-1362 # 78c0 <csem_free+0x186e>
...
0000000000002e2c <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2e42:	47a50513          	addi	a0,a0,1146 # 62b8 <csem_free+0x266>
  ...
  if(chdir("dirfile") == 0){
    ...
    2e5e:	45e50513          	addi	a0,a0,1118 # 62b8 <csem_free+0x266>
  ...
  fd = open("dirfile/xx", 0);
    ...
    2e72:	ab250513          	addi	a0,a0,-1358 # 7920 <csem_free+0x18ce>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2e8a:	a9a50513          	addi	a0,a0,-1382 # 7920 <csem_free+0x18ce>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2e9e:	a8650513          	addi	a0,a0,-1402 # 7920 <csem_free+0x18ce>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2eb2:	a7250513          	addi	a0,a0,-1422 # 7920 <csem_free+0x18ce>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2ec6:	a5e58593          	addi	a1,a1,-1442 # 7920 <csem_free+0x18ce>
    2eca:	00004517          	auipc	a0,0x4
    2ece:	85e50513          	addi	a0,a0,-1954 # 6728 <csem_free+0x6d6>
  ...
  if(unlink("dirfile") != 0){
    ...
    2ee2:	3da50513          	addi	a0,a0,986 # 62b8 <csem_free+0x266>
  ...
  fd = open(".", O_RDWR);
    ...
    2ef8:	c2450513          	addi	a0,a0,-988 # 6b18 <csem_free+0xac6>
  ...
  fd = open(".", 0);
    ...
    2f0e:	c0e50513          	addi	a0,a0,-1010 # 6b18 <csem_free+0xac6>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2f22:	6d258593          	addi	a1,a1,1746 # 65f0 <csem_free+0x59e>
  ...
  close(fd);
    ...
    2f4e:	99650513          	addi	a0,a0,-1642 # 78e0 <csem_free+0x188e>
    ...
    2f6a:	99a50513          	addi	a0,a0,-1638 # 7900 <csem_free+0x18ae>
    ...
    2f86:	9ae50513          	addi	a0,a0,-1618 # 7930 <csem_free+0x18de>
    ...
    2fa2:	99250513          	addi	a0,a0,-1646 # 7930 <csem_free+0x18de>
    ...
    2fbe:	99e50513          	addi	a0,a0,-1634 # 7958 <csem_free+0x1906>
    ...
    2fda:	9aa50513          	addi	a0,a0,-1622 # 7980 <csem_free+0x192e>
    ...
    2ff6:	9b650513          	addi	a0,a0,-1610 # 79a8 <csem_free+0x1956>
    ...
    3012:	9c250513          	addi	a0,a0,-1598 # 79d0 <csem_free+0x197e>
    ...
    302e:	9c650513          	addi	a0,a0,-1594 # 79f0 <csem_free+0x199e>
    ...
    304a:	9d250513          	addi	a0,a0,-1582 # 7a18 <csem_free+0x19c6>
...
0000000000003060 <reparent>:
{
  ...
  exit(0);
    ...
    30b4:	28850513          	addi	a0,a0,648 # 6338 <csem_free+0x2e6>
    ...
    30d0:	28450513          	addi	a0,a0,644 # 6350 <csem_free+0x2fe>
...
0000000000003112 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3138:	f5478793          	addi	a5,a5,-172 # 6088 <csem_free+0x36>
    313c:	f6f43823          	sd	a5,-144(s0)
    3140:	00003797          	auipc	a5,0x3
    3144:	f5078793          	addi	a5,a5,-176 # 6090 <csem_free+0x3e>
    3148:	f6f43c23          	sd	a5,-136(s0)
    314c:	00003797          	auipc	a5,0x3
    3150:	f4c78793          	addi	a5,a5,-180 # 6098 <csem_free+0x46>
    3154:	f8f43023          	sd	a5,-128(s0)
    3158:	00003797          	auipc	a5,0x3
    315c:	f4878793          	addi	a5,a5,-184 # 60a0 <csem_free+0x4e>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    31b4:	e30a0a13          	addi	s4,s4,-464 # bfe0 <buf>
    31b8:	00009a97          	auipc	s5,0x9
    31bc:	e29a8a93          	addi	s5,s5,-471 # bfe1 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    31d4:	c3050513          	addi	a0,a0,-976 # 6e00 <csem_free+0xdae>
    ...
    3250:	7e450513          	addi	a0,a0,2020 # 7a30 <csem_free+0x19de>
    ...
    326a:	7da50513          	addi	a0,a0,2010 # 7a40 <csem_free+0x19ee>
    ...
    3292:	7ca50513          	addi	a0,a0,1994 # 7a58 <csem_free+0x1a06>
    ...
    32c2:	d2278793          	addi	a5,a5,-734 # bfe0 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3320:	74c50513          	addi	a0,a0,1868 # 7a68 <csem_free+0x1a16>
...
0000000000003354 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3394:	c5090913          	addi	s2,s2,-944 # bfe0 <buf>
  for(i = 0; i < N; i++){
    3398:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    33dc:	6a850513          	addi	a0,a0,1704 # 7a80 <csem_free+0x1a2e>
  ...
  for(i = 0; ; i++){
    ...
    33f2:	bf290913          	addi	s2,s2,-1038 # bfe0 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    3440:	65450513          	addi	a0,a0,1620 # 7a90 <csem_free+0x1a3e>
    ...
    345c:	65850513          	addi	a0,a0,1624 # 7ab0 <csem_free+0x1a5e>
    ...
    3478:	65c50513          	addi	a0,a0,1628 # 7ad0 <csem_free+0x1a7e>
    ...
    3494:	66050513          	addi	a0,a0,1632 # 7af0 <csem_free+0x1a9e>
    ...
    34b0:	66450513          	addi	a0,a0,1636 # 7b10 <csem_free+0x1abe>
    ...
    34cc:	66050513          	addi	a0,a0,1632 # 7b28 <csem_free+0x1ad6>
  ...
  unlink("bigfile.dat");
    ...
    34fa:	58a50513          	addi	a0,a0,1418 # 7a80 <csem_free+0x1a2e>
    ...
    351e:	62e50513          	addi	a0,a0,1582 # 7b48 <csem_free+0x1af6>
...
0000000000003534 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    3550:	08c50513          	addi	a0,a0,140 # 65d8 <csem_free+0x586>
  ...
  if(pid == 0){
    ...
    357a:	062a0a13          	addi	s4,s4,98 # 65d8 <csem_free+0x586>
      int n = write(fd, "1234567890", 10);
    357e:	00004a97          	auipc	s5,0x4
    3582:	5eaa8a93          	addi	s5,s5,1514 # 7b68 <csem_free+0x1b16>
      int fd = open("truncfile", O_WRONLY);
    3586:	4585                	li	a1,1
    3588:	8552                	mv	a0,s4
    ...
    35f2:	d4a50513          	addi	a0,a0,-694 # 6338 <csem_free+0x2e6>
    ...
    360e:	6ae50513          	addi	a0,a0,1710 # 6cb8 <csem_free+0xc66>
    ...
    362c:	55050513          	addi	a0,a0,1360 # 7b78 <csem_free+0x1b26>
    ...
    364a:	f92a0a13          	addi	s4,s4,-110 # 65d8 <csem_free+0x586>
    int n = write(fd, "xxx", 3);
    364e:	00004a97          	auipc	s5,0x4
    3652:	54aa8a93          	addi	s5,s5,1354 # 7b98 <csem_free+0x1b46>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    369c:	f4050513          	addi	a0,a0,-192 # 65d8 <csem_free+0x586>
  ...
  exit(xstatus);
    ...
    36ba:	60250513          	addi	a0,a0,1538 # 6cb8 <csem_free+0xc66>
    ...
    36d8:	4cc50513          	addi	a0,a0,1228 # 7ba0 <csem_free+0x1b4e>
...
00000000000036ee <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    370c:	4b850513          	addi	a0,a0,1208 # 7bc0 <csem_free+0x1b6e>
  ...
  if(fd < 0){
    ...
    3724:	4c898993          	addi	s3,s3,1224 # 7be8 <csem_free+0x1b96>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
    3728:	00004a97          	auipc	s5,0x4
    372c:	4f8a8a93          	addi	s5,s5,1272 # 7c20 <csem_free+0x1bce>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
    ...
    3772:	45250513          	addi	a0,a0,1106 # 7bc0 <csem_free+0x1b6e>
  ...
  i = read(fd, buf, N*SZ*2);
    ...
    378c:	85858593          	addi	a1,a1,-1960 # bfe0 <buf>
  ...
  if(unlink("small") < 0){
    ...
    37ae:	41650513          	addi	a0,a0,1046 # 7bc0 <csem_free+0x1b6e>
    ...
    37d8:	3f450513          	addi	a0,a0,1012 # 7bc8 <csem_free+0x1b76>
    ...
    37f6:	40650513          	addi	a0,a0,1030 # 7bf8 <csem_free+0x1ba6>
    ...
    3814:	42050513          	addi	a0,a0,1056 # 7c30 <csem_free+0x1bde>
    ...
    3830:	42c50513          	addi	a0,a0,1068 # 7c58 <csem_free+0x1c06>
    ...
    384c:	48850513          	addi	a0,a0,1160 # 6cd0 <csem_free+0xc7e>
    ...
    3868:	41450513          	addi	a0,a0,1044 # 7c78 <csem_free+0x1c26>
...
000000000000387e <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    389a:	40250513          	addi	a0,a0,1026 # 7c98 <csem_free+0x1c46>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    38ae:	73690913          	addi	s2,s2,1846 # bfe0 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
    ...
    38ec:	3b050513          	addi	a0,a0,944 # 7c98 <csem_free+0x1c46>
  ...
  n = 0;
    ...
    3900:	6e490913          	addi	s2,s2,1764 # bfe0 <buf>
  if(fd < 0){
    ...
    3934:	37050513          	addi	a0,a0,880 # 7ca0 <csem_free+0x1c4e>
    ...
    3952:	37250513          	addi	a0,a0,882 # 7cc0 <csem_free+0x1c6e>
    ...
    396e:	37e50513          	addi	a0,a0,894 # 7ce8 <csem_free+0x1c96>
  ...
  if(unlink("big") < 0){
    ...
    399a:	30250513          	addi	a0,a0,770 # 7c98 <csem_free+0x1c46>
    ...
    39c6:	34650513          	addi	a0,a0,838 # 7d08 <csem_free+0x1cb6>
    ...
    39e4:	35050513          	addi	a0,a0,848 # 7d30 <csem_free+0x1cde>
    ...
    3a02:	34a50513          	addi	a0,a0,842 # 7d48 <csem_free+0x1cf6>
    ...
    3a1e:	35650513          	addi	a0,a0,854 # 7d70 <csem_free+0x1d1e>
...
0000000000003ab4 <killstatus>:
{
  ...
  exit(0);
    ...
    3b1c:	82050513          	addi	a0,a0,-2016 # 6338 <csem_free+0x2e6>
    ...
    3b42:	24a50513          	addi	a0,a0,586 # 7d88 <csem_free+0x1d36>
...
0000000000003b58 <reparent2>:
{
  ...
  exit(0);
    ...
    3b90:	27450513          	addi	a0,a0,628 # 6e00 <csem_free+0xdae>
...
0000000000003bc0 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3c44:	16850513          	addi	a0,a0,360 # 7da8 <csem_free+0x1d56>
...
0000000000003c64 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    3cfa:	0e250513          	addi	a0,a0,226 # 7dd8 <csem_free+0x1d86>
    ...
    3d16:	0ee50513          	addi	a0,a0,238 # 7e00 <csem_free+0x1dae>
  ...
  fd = open("sharedfd", 0);
    ...
    3d5a:	07250513          	addi	a0,a0,114 # 7dc8 <csem_free+0x1d76>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3d9a:	08a50513          	addi	a0,a0,138 # 7e20 <csem_free+0x1dce>
  ...
  unlink("sharedfd");
    ...
    3dd6:	ff650513          	addi	a0,a0,-10 # 7dc8 <csem_free+0x1d76>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3dfc:	05050513          	addi	a0,a0,80 # 7e48 <csem_free+0x1df6>
...
0000000000003e1c <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    3e8a:	f7a50513          	addi	a0,a0,-134 # 6e00 <csem_free+0xdae>
    ...
    3eb6:	dae50513          	addi	a0,a0,-594 # 6c60 <csem_free+0xc0e>
    ...
    3f28:	04450513          	addi	a0,a0,68 # 6f68 <csem_free+0xf16>
    ...
    3f5c:	f0850513          	addi	a0,a0,-248 # 7e60 <csem_free+0x1e0e>
    ...
    3fc2:	eca50513          	addi	a0,a0,-310 # 7e88 <csem_free+0x1e36>
...
0000000000004042 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4070:	e44b8b93          	addi	s7,s7,-444 # 7eb0 <csem_free+0x1e5e>
  for(i = 0; i < N; i++){
    ...
    40b2:	e0a50513          	addi	a0,a0,-502 # 7eb8 <csem_free+0x1e66>
    ...
    40d0:	de450513          	addi	a0,a0,-540 # 7eb0 <csem_free+0x1e5e>
  ...
  fd = open(".", 0);
    ...
    4108:	a1450513          	addi	a0,a0,-1516 # 6b18 <csem_free+0xac6>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    417e:	d5e50513          	addi	a0,a0,-674 # 7ed8 <csem_free+0x1e86>
    ...
    419e:	d5e50513          	addi	a0,a0,-674 # 7ef8 <csem_free+0x1ea6>
  ...
  for(i = 0; i < N; i++){
    ...
    41d6:	d4e50513          	addi	a0,a0,-690 # 7f20 <csem_free+0x1ece>
    ...
    41f2:	14a50513          	addi	a0,a0,330 # 6338 <csem_free+0x2e6>
...
000000000000439c <linkunlink>:
{
  ...
  unlink("x");
    ...
    43bc:	23850513          	addi	a0,a0,568 # 65f0 <csem_free+0x59e>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    43f8:	1fca8a93          	addi	s5,s5,508 # 65f0 <csem_free+0x59e>
      link("cat", "x");
    43fc:	00004b97          	auipc	s7,0x4
    4400:	b5cb8b93          	addi	s7,s7,-1188 # 7f58 <csem_free+0x1f06>
    4404:	a825                	j	443c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    4406:	85a6                	mv	a1,s1
    4408:	00002517          	auipc	a0,0x2
    440c:	f3050513          	addi	a0,a0,-208 # 6338 <csem_free+0x2e6>
...
000000000000449e <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    44ee:	a76a0a13          	addi	s4,s4,-1418 # 7f60 <csem_free+0x1f0e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    4540:	a2450513          	addi	a0,a0,-1500 # 7f60 <csem_free+0x1f0e>
  ...
  for(i = 0; i < N; i++){
    ...
    45b0:	9bc50513          	addi	a0,a0,-1604 # 7f68 <csem_free+0x1f16>
    ...
    45d0:	9bc50513          	addi	a0,a0,-1604 # 7f88 <csem_free+0x1f36>
    ...
    45ec:	9c050513          	addi	a0,a0,-1600 # 7fa8 <csem_free+0x1f56>
...
0000000000004602 <manywrites>:
{
  ...
  exit(0);
    ...
    465e:	7a650513          	addi	a0,a0,1958 # 6e00 <csem_free+0xdae>
    ...
    469a:	94ab0b13          	addi	s6,s6,-1718 # bfe0 <buf>
    ...
    470e:	8be50513          	addi	a0,a0,-1858 # 7fc8 <csem_free+0x1f76>
    ...
    472e:	f2650513          	addi	a0,a0,-218 # 6650 <csem_free+0x5fe>
...
000000000000474c <iref>:
{
    ...
    476a:	87aa0a13          	addi	s4,s4,-1926 # 7fe0 <csem_free+0x1f8e>
    mkdir("");
    476e:	00003497          	auipc	s1,0x3
    4772:	dd248493          	addi	s1,s1,-558 # 7540 <csem_free+0x14ee>
    link("README", "");
    4776:	00002a97          	auipc	s5,0x2
    477a:	fb2a8a93          	addi	s5,s5,-78 # 6728 <csem_free+0x6d6>
    fd = open("xx", O_CREATE);
    477e:	00003997          	auipc	s3,0x3
    4782:	1aa98993          	addi	s3,s3,426 # 7928 <csem_free+0x18d6>
    4786:	a891                	j	47da <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4788:	85da                	mv	a1,s6
    478a:	00004517          	auipc	a0,0x4
    478e:	85e50513          	addi	a0,a0,-1954 # 7fe8 <csem_free+0x1f96>
    ...
    47aa:	85a50513          	addi	a0,a0,-1958 # 8000 <csem_free+0x1fae>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    483e:	a2698993          	addi	s3,s3,-1498 # 7260 <csem_free+0x120e>
    unlink("irefd");
    4842:	00003917          	auipc	s2,0x3
    4846:	79e90913          	addi	s2,s2,1950 # 7fe0 <csem_free+0x1f8e>
    chdir("..");
    484a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4866:	9a650513          	addi	a0,a0,-1626 # 7208 <csem_free+0x11b6>
...
0000000000004886 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    48c2:	6705                	lui	a4,0x1
      *b = 99;
    48c4:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1010>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    48dc:	74050513          	addi	a0,a0,1856 # 8018 <csem_free+0x1fc6>
  ...
  for(i = 0; i < 5000; i++){
    ...
    492e:	70e50513          	addi	a0,a0,1806 # 8038 <csem_free+0x1fe6>
  ...
  if(c != a + 1){
    ...
    4992:	70a50513          	addi	a0,a0,1802 # 8098 <csem_free+0x2046>
    ...
    49b2:	6aa50513          	addi	a0,a0,1706 # 8058 <csem_free+0x2006>
    ...
    49ce:	6ae50513          	addi	a0,a0,1710 # 8078 <csem_free+0x2026>
...
0000000000004a0a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    4a6c:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f100f>
  a = sbrk(0);
    4a70:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    4ad0:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f100f>
  ...
  if(c != a){
    ...
    4b18:	5a450513          	addi	a0,a0,1444 # 80b8 <csem_free+0x2066>
    ...
    4b34:	5d050513          	addi	a0,a0,1488 # 8100 <csem_free+0x20ae>
    ...
    4b54:	5d050513          	addi	a0,a0,1488 # 8120 <csem_free+0x20ce>
    ...
    4b74:	5f050513          	addi	a0,a0,1520 # 8160 <csem_free+0x210e>
    ...
    4b90:	60450513          	addi	a0,a0,1540 # 8190 <csem_free+0x213e>
    ...
    4bb0:	61c50513          	addi	a0,a0,1564 # 81c8 <csem_free+0x2176>
...
0000000000004bc6 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    4be2:	35098993          	addi	s3,s3,848 # c350 <buf+0x370>
    4be6:	1003d937          	lui	s2,0x1003d
    4bea:	090e                	slli	s2,s2,0x3
    4bec:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e490>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    4c30:	70c50513          	addi	a0,a0,1804 # 6338 <csem_free+0x2e6>
    ...
    4c52:	5a250513          	addi	a0,a0,1442 # 81f0 <csem_free+0x219e>
...
0000000000004c72 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4ca8:	bc450513          	addi	a0,a0,-1084 # 6868 <csem_free+0x816>
    ...
    4cdc:	91858593          	addi	a1,a1,-1768 # 65f0 <csem_free+0x59e>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4da2:	47250513          	addi	a0,a0,1138 # 8210 <csem_free+0x21be>
    ...
    4dbe:	57e50513          	addi	a0,a0,1406 # 6338 <csem_free+0x2e6>
    ...
    4df4:	6705                	lui	a4,0x1
      n += *(a+i);
    4df6:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1010>
    ...
    4e0a:	42a50513          	addi	a0,a0,1066 # 8230 <csem_free+0x21de>
...
0000000000004e2a <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4e4c:	41850513          	addi	a0,a0,1048 # 8260 <csem_free+0x220e>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4e6c:	408c8c93          	addi	s9,s9,1032 # 8270 <csem_free+0x221e>
    int total = 0;
    4e70:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4e72:	00007a17          	auipc	s4,0x7
    4e76:	16ea0a13          	addi	s4,s4,366 # bfe0 <buf>
    name[0] = 'f';
    ...
    4ee6:	39e50513          	addi	a0,a0,926 # 8280 <csem_free+0x222e>
  ...
  printf("fsfull test finished\n");
    ...
    4f5c:	34850513          	addi	a0,a0,840 # 82a0 <csem_free+0x224e>
    ...
    4fac:	2e850513          	addi	a0,a0,744 # 8290 <csem_free+0x223e>
...
0000000000004fca <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4fd4:	7e070713          	addi	a4,a4,2016 # 87b0 <randstate>
    4fd8:	6308                	ld	a0,0(a4)
    4fda:	001967b7          	lui	a5,0x196
    4fde:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x18761d>
    4fe2:	02f50533          	mul	a0,a0,a5
    4fe6:	3c6ef7b7          	lui	a5,0x3c6ef
    4fea:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e036f>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    5038:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0010>
    503c:	85a6                	mv	a1,s1
    503e:	00003517          	auipc	a0,0x3
    5042:	27a50513          	addi	a0,a0,634 # 82b8 <csem_free+0x2266>
    ...
    505e:	2de50513          	addi	a0,a0,734 # 6338 <csem_free+0x2e6>
...
000000000000507e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    50b6:	d4e50513          	addi	a0,a0,-690 # 6e00 <csem_free+0xdae>
  ...
  if(pid == 0){
    ...
    510c:	cf850513          	addi	a0,a0,-776 # 6e00 <csem_free+0xdae>
  ...
  if(pid == 0){
    ...
    516c:	c9850513          	addi	a0,a0,-872 # 6e00 <csem_free+0xdae>
...
0000000000005196 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    520a:	0da50513          	addi	a0,a0,218 # 82e0 <csem_free+0x228e>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5222:	3d258593          	addi	a1,a1,978 # 65f0 <csem_free+0x59e>
    ...
    5238:	0cc50513          	addi	a0,a0,204 # 8300 <csem_free+0x22ae>
    ...
    5252:	09a50513          	addi	a0,a0,154 # 82e8 <csem_free+0x2296>
    ...
    526c:	08050513          	addi	a0,a0,128 # 82e8 <csem_free+0x2296>
  ...
  unlink("junk");
    ...
    5290:	05450513          	addi	a0,a0,84 # 82e0 <csem_free+0x228e>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    52e8:	b1c50513          	addi	a0,a0,-1252 # 6e00 <csem_free+0xdae>
    ...
    533c:	24850513          	addi	a0,a0,584 # 6580 <csem_free+0x52e>
    5340:	faa43c23          	sd	a0,-72(s0)
    5344:	00001797          	auipc	a5,0x1
    5348:	2ac78793          	addi	a5,a5,684 # 65f0 <csem_free+0x59e>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    53aa:	24a98993          	addi	s3,s3,586 # 65f0 <csem_free+0x59e>
      uint64 a = (uint64) sbrk(4096);
    ...
    53dc:	f7850513          	addi	a0,a0,-136 # 8350 <csem_free+0x22fe>
    ...
    53f6:	f1e50513          	addi	a0,a0,-226 # 8310 <csem_free+0x22be>
    ...
    5410:	f2450513          	addi	a0,a0,-220 # 8330 <csem_free+0x22de>
  ...
  while(1){
    ...
    545e:	f1650513          	addi	a0,a0,-234 # 8370 <csem_free+0x231e>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    54ae:	ee650513          	addi	a0,a0,-282 # 8390 <csem_free+0x233e>
  ...
  if(pid == 0) {
    ...
    54de:	ede50513          	addi	a0,a0,-290 # 83b8 <csem_free+0x2366>
    ...
    5502:	ea250513          	addi	a0,a0,-350 # 83a0 <csem_free+0x234e>
    ...
    552a:	e9a50513          	addi	a0,a0,-358 # 83c0 <csem_free+0x236e>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    5572:	f6a78793          	addi	a5,a5,-150 # 84d8 <csem_free+0x2486>
    5576:	d1040713          	addi	a4,s0,-752
    557a:	00003897          	auipc	a7,0x3
    557e:	20688893          	addi	a7,a7,518 # 8780 <csem_free+0x272e>
  ...
  printf("usertests starting\n");
    ...
    55ae:	ece50513          	addi	a0,a0,-306 # 8478 <csem_free+0x2426>
  ...
  if(fail){
    ...
    55e6:	e4e50513          	addi	a0,a0,-434 # 8430 <csem_free+0x23de>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5602:	dca58593          	addi	a1,a1,-566 # 83c8 <csem_free+0x2376>
    ...
    5618:	e9c58593          	addi	a1,a1,-356 # 84b0 <csem_free+0x245e>
    ...
    563c:	d9850513          	addi	a0,a0,-616 # 83d0 <csem_free+0x237e>
  ...
  if(fail){
    ...
    56a8:	d7450513          	addi	a0,a0,-652 # 8418 <csem_free+0x23c6>
    ...
    56c2:	da250513          	addi	a0,a0,-606 # 8460 <csem_free+0x240e>
    ...
    5720:	dbc78793          	addi	a5,a5,-580 # 84d8 <csem_free+0x2486>
    5724:	d1040713          	addi	a4,s0,-752
    5728:	00003897          	auipc	a7,0x3
    572c:	05888893          	addi	a7,a7,88 # 8780 <csem_free+0x272e>
    ...
    575c:	d3850513          	addi	a0,a0,-712 # 8490 <csem_free+0x243e>
    5760:	00000097          	auipc	ra,0x0
    5764:	65c080e7          	jalr	1628(ra) # 5dbc <printf>
        printf("SOME TESTS FAILED\n");
    5768:	00003a97          	auipc	s5,0x3
    576c:	cb0a8a93          	addi	s5,s5,-848 # 8418 <csem_free+0x23c6>
        if(continuous != 2)
    5770:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    5772:	00003b17          	auipc	s6,0x3
    5776:	c86b0b13          	addi	s6,s6,-890 # 83f8 <csem_free+0x23a6>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5b2c:	c6850513          	addi	a0,a0,-920 # 8790 <digits>
    5b30:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5bf8:	b9cb8b93          	addi	s7,s7,-1124 # 8790 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5d38:	a5490913          	addi	s2,s2,-1452 # 8788 <csem_free+0x2736>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5e00:	9c47b783          	ld	a5,-1596(a5) # 87c0 <freep>
    ...
    5e2e:	00e6ea63          	bltu	a3,a4,5e42 <free+0x50>
{
  ...
  freep = p;
    ...
    5e70:	94f73a23          	sd	a5,-1708(a4) # 87c0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5ea2:	92253503          	ld	a0,-1758(a0) # 87c0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5eca:	8fa90913          	addi	s2,s2,-1798 # 87c0 <freep>
  if(p == (char*)-1)
    5ece:	5afd                	li	s5,-1
    5ed0:	a895                	j	5f44 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5ed2:	00009797          	auipc	a5,0x9
    5ed6:	10e78793          	addi	a5,a5,270 # efe0 <base>
    5eda:	00003717          	auipc	a4,0x3
    5ede:	8ef73323          	sd	a5,-1818(a4) # 87c0 <freep>
    ...
    5f06:	8aa73f23          	sd	a0,-1858(a4) # 87c0 <freep>
      return (void*)(p + 1);
...
void csem_down(struct counting_semaphore *sem) {
    ...
    5f6a:	84aa                	mv	s1,a0
    bsem_down(sem->bsem2);
    5f6c:	4148                	lw	a0,4(a0)
    5f6e:	00000097          	auipc	ra,0x0
    5f72:	b34080e7          	jalr	-1228(ra) # 5aa2 <bsem_down>
    bsem_down(sem->bsem1);
    5f76:	4088                	lw	a0,0(s1)
    5f78:	00000097          	auipc	ra,0x0
    5f7c:	b2a080e7          	jalr	-1238(ra) # 5aa2 <bsem_down>
    sem->count -= 1;
    5f80:	449c                	lw	a5,8(s1)
    5f82:	37fd                	addiw	a5,a5,-1
    5f84:	0007871b          	sext.w	a4,a5
    5f88:	c49c                	sw	a5,8(s1)
    if (sem->count > 0)
    5f8a:	00e04c63          	bgtz	a4,5fa2 <csem_down+0x42>
    	bsem_up(sem->bsem2);
    bsem_up(sem->bsem1);
    5f8e:	4088                	lw	a0,0(s1)
    5f90:	00000097          	auipc	ra,0x0
    5f94:	b1a080e7          	jalr	-1254(ra) # 5aaa <bsem_up>
}
    5f98:	60e2                	ld	ra,24(sp)
    5f9a:	6442                	ld	s0,16(sp)
    5f9c:	64a2                	ld	s1,8(sp)
    5f9e:	6105                	addi	sp,sp,32
    5fa0:	8082                	ret
    	bsem_up(sem->bsem2);
    5fa2:	40c8                	lw	a0,4(s1)
    5fa4:	00000097          	auipc	ra,0x0
    5fa8:	b06080e7          	jalr	-1274(ra) # 5aaa <bsem_up>
    5fac:	b7cd                	j	5f8e <csem_down+0x2e>

0000000000005fae <csem_up>:


void csem_up(struct counting_semaphore *sem) {
    5fae:	1101                	addi	sp,sp,-32
    5fb0:	ec06                	sd	ra,24(sp)
    5fb2:	e822                	sd	s0,16(sp)
    5fb4:	e426                	sd	s1,8(sp)
    5fb6:	1000                	addi	s0,sp,32
    5fb8:	84aa                	mv	s1,a0
	bsem_down(sem->bsem1);
    5fba:	4108                	lw	a0,0(a0)
    5fbc:	00000097          	auipc	ra,0x0
    5fc0:	ae6080e7          	jalr	-1306(ra) # 5aa2 <bsem_down>
	sem->count += 1;
    5fc4:	449c                	lw	a5,8(s1)
    5fc6:	2785                	addiw	a5,a5,1
    5fc8:	0007871b          	sext.w	a4,a5
    5fcc:	c49c                	sw	a5,8(s1)
	if (sem->count == 1)
    5fce:	4785                	li	a5,1
    5fd0:	00f70c63          	beq	a4,a5,5fe8 <csem_up+0x3a>
		bsem_up(sem->bsem2);
	bsem_up(sem->bsem1);
    5fd4:	4088                	lw	a0,0(s1)
    5fd6:	00000097          	auipc	ra,0x0
    5fda:	ad4080e7          	jalr	-1324(ra) # 5aaa <bsem_up>
}
    5fde:	60e2                	ld	ra,24(sp)
    5fe0:	6442                	ld	s0,16(sp)
    5fe2:	64a2                	ld	s1,8(sp)
    5fe4:	6105                	addi	sp,sp,32
    5fe6:	8082                	ret
		bsem_up(sem->bsem2);
    5fe8:	40c8                	lw	a0,4(s1)
    5fea:	00000097          	auipc	ra,0x0
    5fee:	ac0080e7          	jalr	-1344(ra) # 5aaa <bsem_up>
    5ff2:	b7cd                	j	5fd4 <csem_up+0x26>

0000000000005ff4 <csem_alloc>:


int csem_alloc(struct counting_semaphore *sem, int count) {
    5ff4:	7179                	addi	sp,sp,-48
    5ff6:	f406                	sd	ra,40(sp)
    5ff8:	f022                	sd	s0,32(sp)
    5ffa:	ec26                	sd	s1,24(sp)
    5ffc:	e84a                	sd	s2,16(sp)
    5ffe:	e44e                	sd	s3,8(sp)
    6000:	1800                	addi	s0,sp,48
    6002:	892a                	mv	s2,a0
    6004:	89ae                	mv	s3,a1
    int bsem1 = bsem_alloc();
    6006:	00000097          	auipc	ra,0x0
    600a:	ab4080e7          	jalr	-1356(ra) # 5aba <bsem_alloc>
    600e:	84aa                	mv	s1,a0
    int bsem2 = bsem_alloc();
    6010:	00000097          	auipc	ra,0x0
    6014:	aaa080e7          	jalr	-1366(ra) # 5aba <bsem_alloc>
    if (bsem1 == -1 || bsem2 == -1)
    6018:	57fd                	li	a5,-1
    601a:	00f48d63          	beq	s1,a5,6034 <csem_alloc+0x40>
    601e:	02f50863          	beq	a0,a5,604e <csem_alloc+0x5a>
        return -1; 
    sem->bsem1 = bsem1;
    6022:	00992023          	sw	s1,0(s2)
    sem->bsem2 = bsem2;
    6026:	00a92223          	sw	a0,4(s2)
    if (count == 0)
    602a:	00098d63          	beqz	s3,6044 <csem_alloc+0x50>
        // Binary semaphore first value = min(1, count)
        bsem_down(sem->bsem2); 
    sem->count = count;
    602e:	01392423          	sw	s3,8(s2)
    return 0;
    6032:	4481                	li	s1,0
}
    6034:	8526                	mv	a0,s1
    6036:	70a2                	ld	ra,40(sp)
    6038:	7402                	ld	s0,32(sp)
    603a:	64e2                	ld	s1,24(sp)
    603c:	6942                	ld	s2,16(sp)
    603e:	69a2                	ld	s3,8(sp)
    6040:	6145                	addi	sp,sp,48
    6042:	8082                	ret
        bsem_down(sem->bsem2); 
    6044:	00000097          	auipc	ra,0x0
    6048:	a5e080e7          	jalr	-1442(ra) # 5aa2 <bsem_down>
    604c:	b7cd                	j	602e <csem_alloc+0x3a>
        return -1; 
    604e:	84aa                	mv	s1,a0
    6050:	b7d5                	j	6034 <csem_alloc+0x40>

0000000000006052 <csem_free>:


void csem_free(struct counting_semaphore *sem) {
    6052:	1101                	addi	sp,sp,-32
    6054:	ec06                	sd	ra,24(sp)
    6056:	e822                	sd	s0,16(sp)
    6058:	e426                	sd	s1,8(sp)
    605a:	1000                	addi	s0,sp,32
    605c:	84aa                	mv	s1,a0
    bsem_free(sem->bsem1);
    605e:	4108                	lw	a0,0(a0)
    6060:	00000097          	auipc	ra,0x0
    6064:	a52080e7          	jalr	-1454(ra) # 5ab2 <bsem_free>
    bsem_free(sem->bsem2);
    6068:	40c8                	lw	a0,4(s1)
    606a:	00000097          	auipc	ra,0x0
    606e:	a48080e7          	jalr	-1464(ra) # 5ab2 <bsem_free>
    free(sem);
    6072:	8526                	mv	a0,s1
    6074:	00000097          	auipc	ra,0x0
    6078:	d7e080e7          	jalr	-642(ra) # 5df2 <free>
}
    607c:	60e2                	ld	ra,24(sp)
    607e:	6442                	ld	s0,16(sp)
    6080:	64a2                	ld	s1,8(sp)
    6082:	6105                	addi	sp,sp,32
    6084:	8082                	ret
